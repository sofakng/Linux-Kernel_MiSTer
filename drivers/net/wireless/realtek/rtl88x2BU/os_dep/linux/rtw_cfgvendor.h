...
extern int rtw_cfgvendor_attach_22b(struct wiphy *wiphy);
extern int rtw_cfgvendor_detach_22b(struct wiphy *wiphy);
extern int rtw_cfgvendor_send_async_event_22b(struct wiphy *wiphy,
