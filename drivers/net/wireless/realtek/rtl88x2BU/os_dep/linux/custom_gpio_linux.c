...
extern unsigned int oob_irq_22b;
#endif /* CONFIG_GSPI_HCI */

#ifdef CONFIG_SDIO_HCI
extern int rtw_mp_mode_22b;
...
#ifdef CONFIG_GSPI_HCI
	if (GPIO_WIFI_IRQ > 0) {
		gpio_request(GPIO_WIFI_IRQ, "oob_irq_22b");
		gpio_direction_input(GPIO_WIFI_IRQ);

		oob_irq_22b = gpio_to_irq(GPIO_WIFI_IRQ);
