			...
			union iwreq_data *wrqu, char *extra)
{
	...
	*(extra + wrqu->data.length) = '\0';
	...
	if (rtw_is_file_readable_22b(rtw_efuse_mask_file_path) == _TRUE) {
		RTW_INFO("%s do rtw_efuse_mask_file_read = %s! ,sizeof maskfileBuffer_22b %zu\n", __func__, rtw_efuse_mask_file_path, sizeof(maskfileBuffer_22b));
		Status = rtw_efuse_file_read_22b(padapter, rtw_efuse_mask_file_path, maskfileBuffer_22b, sizeof(maskfileBuffer_22b));
		if (Status == _TRUE) {
			padapter->registrypriv.bFileMaskEfuse = _TRUE;
		       ...
		       union iwreq_data *wrqu, char *extra)
{
	...
	if (rtw_is_file_readable_22b(rtw_efuse_file_map_path) == _TRUE) {
		RTW_INFO("%s do rtw_efuse_mask_file_read = %s!\n", __func__, rtw_efuse_file_map_path);
		Status = rtw_efuse_file_read_22b(padapter, rtw_efuse_file_map_path, pEfuseHal->fakeEfuseModifiedMap_22b, sizeof(pEfuseHal->fakeEfuseModifiedMap_22b));
		if (Status == _TRUE) {
				...
				union iwreq_data *wrqu, char *extra)
{
	...
	if (rtw_is_file_readable_22b(rtw_efuse_file_map_path) == _TRUE) {
		RTW_INFO("%s do rtw_efuse_mask_file_read = %s!\n", __func__, rtw_efuse_file_map_path);
		Status = rtw_efuse_file_read_22b(padapter, rtw_efuse_file_map_path, pEfuseHal->fakeBTEfuseModifiedMap_22b_22b, sizeof(pEfuseHal->fakeBTEfuseModifiedMap_22b_22b));
		if (Status == _TRUE) {
