...
void hal_mpt_SwitchRfSetting_22b(PADAPTER	pAdapter)
{
...
s32 hal_mpt_SetPowerTracking_22b(PADAPTER padapter, u8 enable)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(padapter);
...
void hal_mpt_GetPowerTracking_22b(PADAPTER padapter, u8 *enable)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(padapter);
	struct dm_struct		*pDM_Odm = &(pHalData->odmpriv);
...
void hal_mpt_CCKTxPowerAdjust_22b(PADAPTER Adapter, BOOLEAN bInCH14)
{
	...
	DataRate = mpt_to_mgnt_rate_22b(ulRateIdx);
	...
	if (IS_HARDWARE_TYPE_8703B(Adapter)) {
		...
		CurrCCKSwingVal = read_bbreg_22b(Adapter, rCCK0_TxFilter1, bMaskHWord);
		...
		if (!pHalData->bCCKinCH14) {
			...
			for (i = 0; i < CCK_TABLE_SIZE_88F; i++) {
				if (((CurrCCKSwingVal & 0xff) == (u32)cck_swing_table_ch1_ch13_22b_88f_22b[i][0]) &&
				    (((CurrCCKSwingVal & 0xff00) >> 8) == (u32)cck_swing_table_ch1_ch13_22b_88f_22b[i][1])) {
					CCKSwingIndex = i;
					break;
				}
			}
			write_bbreg_22b(Adapter, 0xa22, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][0]);
			write_bbreg_22b(Adapter, 0xa23, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][1]);
			write_bbreg_22b(Adapter, 0xa24, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][2]);
			write_bbreg_22b(Adapter, 0xa25, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][3]);
			write_bbreg_22b(Adapter, 0xa26, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][4]);
			write_bbreg_22b(Adapter, 0xa27, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][5]);
			write_bbreg_22b(Adapter, 0xa28, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][6]);
			write_bbreg_22b(Adapter, 0xa29, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][7]);
			write_bbreg_22b(Adapter, 0xa9a, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][8]);
			write_bbreg_22b(Adapter, 0xa9b, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][9]);
			write_bbreg_22b(Adapter, 0xa9c, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][10]);
			write_bbreg_22b(Adapter, 0xa9d, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][11]);
			write_bbreg_22b(Adapter, 0xaa0, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][12]);
			write_bbreg_22b(Adapter, 0xaa1, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][13]);
			write_bbreg_22b(Adapter, 0xaa2, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][14]);
			write_bbreg_22b(Adapter, 0xaa3, bMaskByte0, cck_swing_table_ch1_ch13_22b_88f_22b[CCKSwingIndex][15]);
			RTW_INFO("%s , cck_swing_table_ch1_ch13_22b_88f_22b[%d]\n", __func__, CCKSwingIndex);
		}  else {
			for (i = 0; i < CCK_TABLE_SIZE_88F; i++) {
				if (((CurrCCKSwingVal & 0xff) == (u32)cck_swing_table_ch14_22b_88f_22b[i][0]) &&
				    (((CurrCCKSwingVal & 0xff00) >> 8) == (u32)cck_swing_table_ch14_22b_88f_22b[i][1])) {
					CCKSwingIndex = i;
					break;
				}
			}
			write_bbreg_22b(Adapter, 0xa22, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][0]);
			write_bbreg_22b(Adapter, 0xa23, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][1]);
			write_bbreg_22b(Adapter, 0xa24, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][2]);
			write_bbreg_22b(Adapter, 0xa25, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][3]);
			write_bbreg_22b(Adapter, 0xa26, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][4]);
			write_bbreg_22b(Adapter, 0xa27, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][5]);
			write_bbreg_22b(Adapter, 0xa28, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][6]);
			write_bbreg_22b(Adapter, 0xa29, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][7]);
			write_bbreg_22b(Adapter, 0xa9a, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][8]);
			write_bbreg_22b(Adapter, 0xa9b, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][9]);
			write_bbreg_22b(Adapter, 0xa9c, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][10]);
			write_bbreg_22b(Adapter, 0xa9d, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][11]);
			write_bbreg_22b(Adapter, 0xaa0, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][12]);
			write_bbreg_22b(Adapter, 0xaa1, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][13]);
			write_bbreg_22b(Adapter, 0xaa2, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][14]);
			write_bbreg_22b(Adapter, 0xaa3, bMaskByte0, cck_swing_table_ch14_22b_88f_22b[CCKSwingIndex][15]);
			RTW_INFO("%s , cck_swing_table_ch14_22b_88f_22b[%d]\n", __func__, CCKSwingIndex);
		}
	} else {
		...
		if (!pHalData->bCCKinCH14) {
			...
			for (i = 0; i < CCK_TABLE_SIZE; i++) {
				if (((CurrCCKSwingVal & 0xff) == (u32)cck_swing_table_ch1_ch13_22b[i][0]) &&
				    (((CurrCCKSwingVal & 0xff00) >> 8) == (u32)cck_swing_table_ch1_ch13_22b[i][1])) {
					CCKSwingIndex = i;
					break;
				}
			}
			...
			/*Write 0xa22 0xa23*/
			TempVal = cck_swing_table_ch1_ch13_22b[CCKSwingIndex][0] +
				(cck_swing_table_ch1_ch13_22b[CCKSwingIndex][1] << 8);


			/*Write 0xa24 ~ 0xa27*/
			TempVal2 = 0;
			TempVal2 = cck_swing_table_ch1_ch13_22b[CCKSwingIndex][2] +
				(cck_swing_table_ch1_ch13_22b[CCKSwingIndex][3] << 8) +
				(cck_swing_table_ch1_ch13_22b[CCKSwingIndex][4] << 16) +
				(cck_swing_table_ch1_ch13_22b[CCKSwingIndex][5] << 24);

			/*Write 0xa28  0xa29*/
			TempVal3 = 0;
			TempVal3 = cck_swing_table_ch1_ch13_22b[CCKSwingIndex][6] +
				(cck_swing_table_ch1_ch13_22b[CCKSwingIndex][7] << 8);
		}  else {
			for (i = 0; i < CCK_TABLE_SIZE; i++) {
				if (((CurrCCKSwingVal & 0xff) == (u32)cck_swing_table_ch14_22b[i][0]) &&
				    (((CurrCCKSwingVal & 0xff00) >> 8) == (u32)cck_swing_table_ch14_22b[i][1])) {
					CCKSwingIndex = i;
					break;
				}
			}
			...
			/*Write 0xa22 0xa23*/
			TempVal = cck_swing_table_ch14_22b[CCKSwingIndex][0] +
				  (cck_swing_table_ch14_22b[CCKSwingIndex][1] << 8);

			/*Write 0xa24 ~ 0xa27*/
			TempVal2 = 0;
			TempVal2 = cck_swing_table_ch14_22b[CCKSwingIndex][2] +
				   (cck_swing_table_ch14_22b[CCKSwingIndex][3] << 8) +
				(cck_swing_table_ch14_22b[CCKSwingIndex][4] << 16) +
				   (cck_swing_table_ch14_22b[CCKSwingIndex][5] << 24);

			/*Write 0xa28  0xa29*/
			TempVal3 = 0;
			TempVal3 = cck_swing_table_ch14_22b[CCKSwingIndex][6] +
				   (cck_swing_table_ch14_22b[CCKSwingIndex][7] << 8);
		}

		write_bbreg_22b(Adapter, rCCK0_TxFilter1, bMaskHWord, TempVal);
		write_bbreg_22b(Adapter, rCCK0_TxFilter2, bMaskDWord, TempVal2);
		write_bbreg_22b(Adapter, rCCK0_DebugPort, bMaskLWord, TempVal3);
	}

}

void hal_mpt_SetChannel_22b(PADAPTER pAdapter)
{
    ...
    if (bandwidth > 0) {
        if ((channel >= 3 && channel <= 11) || (channel >= 42 && channel <= 171))
            rtw_hal_set_chnl_bw_22b(pAdapter, channel, bandwidth, pmp->prime_channel_offset, pmp->prime_channel_offset);
        else
            rtw_hal_set_chnl_bw_22b(pAdapter, channel, bandwidth, 0, 0);
    } else
	    rtw_hal_set_chnl_bw_22b(pAdapter, channel, bandwidth, 0, 0);

	hal_mpt_CCKTxPowerAdjust_22b(pAdapter, pHalData->bCCKinCH14);
 ...
 */
void hal_mpt_SetBandwidth_22b(PADAPTER pAdapter)
{
	struct mp_priv *pmp = &pAdapter->mppriv;
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
...
void mpt_SetTxPower_22b_Old(PADAPTER pAdapter, MPT_TXPWR_DEF Rate, u8 *pTxPower)
{
	switch (Rate) {
	case MPT_CCK: {
	...
	RTW_INFO("<===mpt_SetTxPower_22b_Old()\n");
}
...
)
{
	...
	case MPT_CCK: {
		...
		for (path = StartPath; path <= EndPath; path++)
			for (i = 0; i < sizeof(rate); ++i)
				PHY_SetTxPower_22bIndex(pAdapter, pTxPower[path], path, rate[i]);
	}
	break;
	case MPT_OFDM: {
		u1Byte rate[] = {
	...
	break;
	default:
		RTW_INFO("<===mpt_SetTxPower_22b: Illegal channel!!\n");
		break;
	}
}

void hal_mpt_SetTxPower_22b(PADAPTER pAdapter)
{
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
	PMPT_CONTEXT		pMptCtx = &(pAdapter->mppriv.mpt_ctx);
	struct dm_struct		*pDM_Odm = &pHalData->odmpriv;
	...
	if (pHalData->rf_chip < RF_CHIP_MAX) {
		if (IS_HARDWARE_TYPE_8188E(pAdapter) ||
			...
			RTW_INFO("===> MPT_ProSetTxPower_22b: Old\n");

			mpt_SetTxPower_22b_Old(pAdapter, MPT_CCK, pMptCtx->TxPwrLevel);
			mpt_SetTxPower_22b_Old(pAdapter, MPT_OFDM_AND_HT, pMptCtx->TxPwrLevel);

		} else {
			RTW_INFO("===> MPT_ProSetTxPower_22b: Jaguar/Jaguar2\n");
			mpt_SetTxPower_22b(pAdapter, MPT_CCK, pMptCtx->TxPwrLevel);
			mpt_SetTxPower_22b(pAdapter, MPT_OFDM, pMptCtx->TxPwrLevel);
			mpt_SetTxPower_22b(pAdapter, MPT_HT, pMptCtx->TxPwrLevel);
			mpt_SetTxPower_22b(pAdapter, MPT_VHT, pMptCtx->TxPwrLevel);
...
void hal_mpt_SetDataRate_22b(PADAPTER pAdapter)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
	PMPT_CONTEXT		pMptCtx = &(pAdapter->mppriv.mpt_ctx);
	u32 DataRate;

	DataRate = mpt_to_mgnt_rate_22b(pMptCtx->mpt_rate_index);
...
VOID mpt_SetRFPath_8814A(PADAPTER	pAdapter)
{
	...
	u8	ForcedDataRate = mpt_to_mgnt_rate_22b(pMptCtx->mpt_rate_index);
	...
	u8	NssforRate = MgntQuery_NssTxRate_22b(ForcedDataRate);

	if (NssforRate == RF_3TX) {
		RTW_INFO("===> SetAntenna_22b 3T Rate ForcedDataRate %d NssforRate %d AntennaTx %d\n", ForcedDataRate, NssforRate, ulAntennaTx);
		...
		RTW_INFO("===> SetAntenna_22b for 1T/2T Rate, ForcedDataRate %d NssforRate %d AntennaTx %d\n", ForcedDataRate, NssforRate, ulAntennaTx);
		switch (ulAntennaTx) {
		case ANTENNA_BCD:
			pMptCtx->mpt_rf_path = RF_PATH_BCD;
			/*pHalData->ValidTxPath = 0x0e;*/
	...
	IN	BOOLEAN	bEnPMacTx)
{
	...
	if (bSingleTone) {
		...
		if (bEnPMacTx == FALSE) {
			hal_mpt_SetContinuousTx_22b(pAdapter, _TRUE);
			issue_nulldata_22b(pAdapter, NULL, 1, 3, 500);
		}
		...
		if (bEnPMacTx == FALSE)
			hal_mpt_SetContinuousTx_22b(pAdapter, _FALSE);
...
VOID mpt_SetRFPath_819X_22b(PADAPTER	pAdapter)
{
	HAL_DATA_TYPE			*pHalData	= GET_HAL_DATA(pAdapter);
	PMPT_CONTEXT		pMptCtx = &(pAdapter->mppriv.mpt_ctx);
	u4Byte			ulAntennaTx, ulAntennaRx;
...
void hal_mpt_SetAntenna_22b(PADAPTER	pAdapter)

{
	...
	*/
	mpt_SetRFPath_819X_22b(pAdapter);
	RTW_INFO("mpt_SetRFPath_819X_22b Do %s\n", __func__);
}

s32 hal_mpt_SetThermalMeter_22b(PADAPTER pAdapter, u8 target_ther)
{
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
...
void hal_mpt_TriggerRFThermalMeter_22b(PADAPTER pAdapter)
{
...
u8 hal_mpt_ReadRFThermalMeter_22b(PADAPTER pAdapter)

{
	...
	thermal_offset = phydm_get_thermal_offset_22b(p_dm_odm);
...
void hal_mpt_GetThermalMeter_22b(PADAPTER pAdapter, u8 *value)
{
#if 0
	...
	*value &= 0xFF;
	...
	rtw_msleep_os_22b(1000);
	*value = hal_mpt_ReadRFThermalMeter_22b(pAdapter);
#endif

}


void hal_mpt_SetSingleCarrierTx_22b(PADAPTER pAdapter, u8 bStart)
{
	HAL_DATA_TYPE *pHalData = GET_HAL_DATA(pAdapter);
...
void hal_mpt_SetSingleToneTx_22b(PADAPTER pAdapter, u8 bStart)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(pAdapter);
	PMPT_CONTEXT		pMptCtx = &(pAdapter->mppriv.mpt_ctx);
	struct dm_struct		*pDM_Odm = &pHalData->odmpriv;
	...
	if (bStart) {
		...
		write_bbreg_22b(pAdapter, rFPGA0_XA_HSSIParameter1, bMaskDWord, 0x01000500);
		write_bbreg_22b(pAdapter, rFPGA0_XB_HSSIParameter1, bMaskDWord, 0x01000500);
		...
		if (IS_HARDWARE_TYPE_8188E(pAdapter)) {
			...
			phy_set_bb_reg(pAdapter, rSingleTone_ContTx_Jaguar, BIT18 | BIT17 | BIT16, OFDM_ALL_OFF);
#endif
		write_bbreg_22b(pAdapter, rFPGA0_XA_HSSIParameter1, bMaskDWord, 0x01000100);
		write_bbreg_22b(pAdapter, rFPGA0_XB_HSSIParameter1, bMaskDWord, 0x01000100);

	}
}

void hal_mpt_SetCarrierSuppressionTx_22b(PADAPTER pAdapter, u8 bStart)
{
	u8 Rate;

	pAdapter->mppriv.mpt_ctx.is_carrier_suppression = bStart;

	Rate = HwRateToMPTRate_22b(pAdapter->mppriv.rateidx);
	if (bStart) {/* Start Carrier Suppression.*/
		if (Rate <= MPT_RATE_11M) {
			/*/ 1. if CCK block on?*/
			if (!read_bbreg_22b(pAdapter, rFPGA0_RFMOD, bCCKEn))
				write_bbreg_22b(pAdapter, rFPGA0_RFMOD, bCCKEn, bEnable);/*set CCK block on*/
			...
			write_bbreg_22b(pAdapter, rCCK0_System, bCCKBBMode, 0x2);    /*/transmit mode*/
			write_bbreg_22b(pAdapter, rCCK0_System, bCCKScramble, 0x0);  /*/turn off scramble setting*/

			/*/Set CCK Tx Test Rate*/
			write_bbreg_22b(pAdapter, rCCK0_System, bCCKTxRate, 0x0);    /*/Set FTxRate to 1Mbps*/
		}
		...
		if (Rate <= MPT_RATE_11M) {
			write_bbreg_22b(pAdapter, rCCK0_System, bCCKBBMode, 0x0);    /*normal mode*/
			write_bbreg_22b(pAdapter, rCCK0_System, bCCKScramble, 0x1);  /*turn on scramble setting*/

			/*BB Reset*/
			write_bbreg_22b(pAdapter, rPMAC_Reset, bBBResetB, 0x0);
			write_bbreg_22b(pAdapter, rPMAC_Reset, bBBResetB, 0x1);
		}
...
u32 hal_mpt_query_phytxok_22b(PADAPTER	pAdapter)
{
	PMPT_CONTEXT pMptCtx = &(pAdapter->mppriv.mpt_ctx);
...
void mpt_ProSetPMacTx(PADAPTER	Adapter)
{
	...
	if (IS_MPT_HT_RATE(PMacTxInfo.TX_RATE)) {
		...
		_rtw_memcpy_22b(&u4bTmp, PMacTxInfo.VHT_SIG_B, 4);
	...
	if (IS_MPT_VHT_RATE(PMacTxInfo.TX_RATE)) {
		...
		_rtw_memcpy_22b(&u4bTmp, PMacTxInfo.VHT_Delimiter, 4);
...
void hal_mpt_SetContinuousTx_22b(PADAPTER pAdapter, u8 bStart)
{
	u8 Rate;

	RTW_INFO("SetContinuousTx_22b: rate:%d\n", pAdapter->mppriv.rateidx);
	Rate = HwRateToMPTRate_22b(pAdapter->mppriv.rateidx);
