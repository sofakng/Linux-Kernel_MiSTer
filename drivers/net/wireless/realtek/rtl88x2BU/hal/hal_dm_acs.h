...
extern void phydm_ccx_monitor_trigger_22b(void *p_dm_void, u16 monitor_time);
extern void phydm_ccx_monitor_result_22b(void *p_dm_void);

#define GET_ACS_STATE(padapter)					(ATOMIC_READ_22b(&GET_HAL_DATA(padapter)->acs.state))
#define SET_ACS_STATE(padapter, set_state)			(ATOMIC_SET_22b(&GET_HAL_DATA(padapter)->acs.state, set_state))
...
#define GET_NM_STATE(padapter)					(ATOMIC_READ_22b(&GET_HAL_DATA(padapter)->nm.state))
#define SET_NM_STATE(padapter, set_state)			(ATOMIC_SET_22b(&GET_HAL_DATA(padapter)->nm.state, set_state))
