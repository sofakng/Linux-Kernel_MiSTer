...
/**
* Function:	PHY_CalculateBitShift_22b
*
	...
	IN	u32				Offset)
{
	...
	if (RF_Shadow[eRFPath][Offset].Compare == _TRUE) {
		reg = rtw_hal_read_rfreg_22b_22b_22b(Adapter, eRFPath, Offset, bRFRegOffsetMask);
	...
	IN	u32				Offset)
{
	...
	if (RF_Shadow[eRFPath][Offset].ErrorOrNot == _TRUE) {
		...
		if (RF_Shadow[eRFPath][Offset].Recorver == _TRUE) {
			rtw_hal_write_rfreg_22b_22b_22b(Adapter, eRFPath, Offset, bRFRegOffsetMask,
