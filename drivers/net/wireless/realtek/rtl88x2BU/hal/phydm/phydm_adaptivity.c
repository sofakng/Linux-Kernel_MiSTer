...
void
phydm_dig_22b_up_bound_lmt_en_22b(
	void			*dm_void
)
{
...
)
{
	...
	if (dm->support_ic_type & ODM_IC_11N_SERIES)
		odm_set_bb_reg_22b(dm, REG_OFDM_0_ECCA_THRESHOLD, MASKBYTE2 | MASKBYTE0, (u32)((u8)L2H | (u8)H2L << 16));
#if (RTL8195A_SUPPORT == 0)
	else if (dm->support_ic_type & ODM_IC_11AC_SERIES)
		odm_set_bb_reg_22b(dm, REG_FPGA0_XB_LSSI_READ_BACK, MASKLWORD, (u16)((u8)L2H | (u8)H2L << 8));
#endif
...
)
{
	...
	if (dm->support_ic_type & (ODM_RTL8188E | ODM_RTL8192E)) {
		if (type == phydm_disable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0000f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0x37f82);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			if (dm->rf_type > RF_1T1R) {
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x1);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x30, 0xfffff, 0x18000);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x31, 0xfffff, 0x0000f);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x32, 0xfffff, 0x37f82);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x0);
			}
		} else if (type == phydm_enable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0000f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0x77f82);	/*back to normal*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			if (dm->rf_type > RF_1T1R) {
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x1);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x30, 0xfffff, 0x18000);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x31, 0xfffff, 0x0000f);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x32, 0xfffff, 0x77f82);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x0);
			}
		}
		...
		if (type == phydm_disable_lna) {
			...
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0001f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xe6137);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			/*S1*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xed, 0x00020, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x43, 0xfffff, 0x3008d);	/*select Rx mode and disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xed, 0x00020, 0x0);
		} else if (type == phydm_enable_lna) {
			/*S0*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0001f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xe6177);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			/*S1*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xed, 0x00020, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x43, 0xfffff, 0x300bd);	/*select Rx mode and disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xed, 0x00020, 0x0);
		}
		...
		if (type == phydm_disable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x3f7ff);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xc22bf);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			if (dm->rf_type > RF_1T1R) {
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x1);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x31, 0xfffff, 0x3f7ff);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x32, 0xfffff, 0xc22bf);	/*disable LNA*/
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x0);
			}
		} else if (type == phydm_enable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x3f7ff);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xc26bf);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
			if (dm->rf_type > RF_1T1R) {
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x1);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x31, 0xfffff, 0x3f7ff);
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0x32, 0xfffff, 0xc26bf);	/*disable LNA*/
				odm_set_rf_reg_22b(dm, RF_PATH_B, 0xef, 0x80000, 0x0);
			}
		}
		...
		if (type == phydm_disable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0002f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xfb09b);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
		} else if (type == phydm_enable_lna) {
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x1);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x30, 0xfffff, 0x18000);	/*select Rx mode*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x31, 0xfffff, 0x0002f);
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0x32, 0xfffff, 0xfb0bb);	/*disable LNA*/
			odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, 0x80000, 0x0);
		}
	}
}
...
)
{
	...
	if (dm->support_ic_type & ODM_IC_11N_SERIES) {
		odm_set_bb_reg_22b(dm, ODM_REG_CCK_RPT_FORMAT_11N, BIT(3) | BIT(2) | BIT(1), tx_mode);			/*set TXmod to standby mode to remove outside noise affect*/
		odm_set_bb_reg_22b(dm, ODM_REG_CCK_RPT_FORMAT_11N, BIT(22) | BIT(21) | BIT(20), rx_mode);		/*set RXmod to standby mode to remove outside noise affect*/
		if (dm->rf_type > RF_1T1R) {
			odm_set_bb_reg_22b(dm, ODM_REG_CCK_RPT_FORMAT_11N_B, BIT(3) | BIT(2) | BIT(1), tx_mode);		/*set TXmod to standby mode to remove outside noise affect*/
			odm_set_bb_reg_22b(dm, ODM_REG_CCK_RPT_FORMAT_11N_B, BIT(22) | BIT(21) | BIT(20), rx_mode);	/*set RXmod to standby mode to remove outside noise affect*/
		}
	}
#if (RTL8195A_SUPPORT == 0)
	else if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
		odm_set_bb_reg_22b(dm, ODM_REG_TRMUX_11AC, BIT(11) | BIT(10) | BIT(9) | BIT(8), tx_mode);				/*set TXmod to standby mode to remove outside noise affect*/
		odm_set_bb_reg_22b(dm, ODM_REG_TRMUX_11AC, BIT(7) | BIT(6) | BIT(5) | BIT(4), rx_mode);				/*set RXmod to standby mode to remove outside noise affect*/
		if (dm->rf_type > RF_1T1R) {
			odm_set_bb_reg_22b(dm, ODM_REG_TRMUX_11AC_B, BIT(11) | BIT(10) | BIT(9) | BIT(8), tx_mode);		/*set TXmod to standby mode to remove outside noise affect*/
			odm_set_bb_reg_22b(dm, ODM_REG_TRMUX_11AC_B, BIT(7) | BIT(6) | BIT(5) | BIT(4), rx_mode);			/*set RXmod to standby mode to remove outside noise affect*/
		}
	}
#endif
...
)
{
	...
	if (state == phydm_ignore_edcca) {
		odm_set_mac_reg_22b(dm, REG_TX_PTCL_CTRL, BIT(15), 1);	/*ignore EDCCA	reg520[15]=1*/
		/*		odm_set_mac_reg_22b(dm, REG_RD_CTRL, BIT(11), 0);			*/ /*reg524[11]=0*/
	} else {	/*don't set MAC ignore EDCCA signal*/
		odm_set_mac_reg_22b(dm, REG_TX_PTCL_CTRL, BIT(15), 0);	/*don't ignore EDCCA	 reg520[15]=0*/
		/*		odm_set_mac_reg_22b(dm, REG_RD_CTRL, BIT(11), 1);			*/ /*reg524[11]=1	*/
	}
...
)
{
	...
	if (dm->support_ic_type & (ODM_RTL8723B | ODM_RTL8188E | ODM_RTL8192E | ODM_RTL8812 | ODM_RTL8821 | ODM_RTL8881A))
		phydm_set_lna_22b(dm, phydm_disable_lna);
	...
	phydm_set_edcca_threshold_22b(dm, th_h2l_dmc, th_l2h_dmc);
	ODM_delay_ms_22b(30);

	while (is_adjust) {
		/*check CCA status*/
		if (phydm_set_bb_dbg_port_22b(dm, BB_DBGPORT_PRIORITY_1, 0x0)) {/*set debug port to 0x0*/
			reg_value32 = phydm_get_bb_dbg_port_value_22b(dm);
		...
		for (cnt = 0; cnt < 20; cnt++) {
			if (phydm_set_bb_dbg_port_22b(dm, BB_DBGPORT_PRIORITY_1, adaptivity->adaptivity_dbg_port)) {
				value32 = phydm_get_bb_dbg_port_value_22b(dm);
				phydm_release_bb_dbg_port_22b(dm);
			}
	...
	if (dm->support_ic_type & (ODM_RTL8723B | ODM_RTL8188E | ODM_RTL8192E | ODM_RTL8812 | ODM_RTL8821 | ODM_RTL8881A))
		phydm_set_lna_22b(dm, phydm_enable_lna);

	phydm_set_edcca_threshold_22b(dm, 0x7f, 0x7f);				/*resume to no link state*/
}

boolean
phydm_re_search_condition_22b(
	void				*dm_void
)
{
	struct dm_struct		*dm = (struct dm_struct *)dm_void;
...
)
{
	...
	phydm_mac_edcca_state_22b(dm, phydm_dont_ignore_edcca);

	if (dm->support_ic_type & ODM_IC_11N_GAIN_IDX_EDCCA) {
		/*odm_set_bb_reg_22b(dm, ODM_REG_EDCCA_DOWN_OPT_11N, BIT(12) | BIT(11) | BIT(10), 0x7);*/		/*interfernce need > 2^x us, and then EDCCA will be 1*/
		if (dm->support_ic_type & ODM_RTL8197F) {
			odm_set_bb_reg_22b(dm, ODM_REG_PAGE_B1_97F, BIT(30), 0x1);								/*set to page B1*/
			odm_set_bb_reg_22b(dm, ODM_REG_EDCCA_DCNF_97F, BIT(27) | BIT(26), 0x1);		/*0:rx_dfir, 1: dcnf_out, 2 :rx_iq, 3: rx_nbi_nf_out*/
			odm_set_bb_reg_22b(dm, ODM_REG_PAGE_B1_97F, BIT(30), 0x0);
		} else
			odm_set_bb_reg_22b(dm, ODM_REG_EDCCA_DCNF_11N, BIT(21) | BIT(20), 0x1);		/*0:rx_dfir, 1: dcnf_out, 2 :rx_iq, 3: rx_nbi_nf_out*/
	}
#if (RTL8195A_SUPPORT == 0)
	if (dm->support_ic_type & ODM_IC_11AC_GAIN_IDX_EDCCA) {		/*8814a no need to find pwdB lower bound, maybe*/
		/*odm_set_bb_reg_22b(dm, ODM_REG_EDCCA_DOWN_OPT, BIT(30) | BIT(29) | BIT(28), 0x7);*/		/*interfernce need > 2^x us, and then EDCCA will be 1*/
		odm_set_bb_reg_22b(dm, ODM_REG_ACBB_EDCCA_ENHANCE, BIT(29) | BIT(28), 0x1);		/*0:rx_dfir, 1: dcnf_out, 2 :rx_iq, 3: rx_nbi_nf_out*/
	}

	if (!(dm->support_ic_type & (ODM_IC_11AC_GAIN_IDX_EDCCA | ODM_IC_11N_GAIN_IDX_EDCCA))) {
		phydm_search_pwdb_lower_bound_22b(dm);
		if (phydm_re_search_condition_22b(dm))
			phydm_search_pwdb_lower_bound_22b(dm);
	} else
		phydm_set_edcca_threshold_22b(dm, 0x7f, 0x7f);				/*resume to no link state*/
#endif
	/*forgetting factor setting*/
	phydm_set_forgetting_factor_22b(dm);

	/*pwdb mode setting with 0: mean, 1:max*/
	phydm_set_pwdb_mode_22b(dm);
...
)
{
	...
	phydm_check_adaptivity_22b(dm);	/*Check adaptivity enable*/
	phydm_dig_22b_up_bound_lmt_en_22b(dm);
	...
	if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
		...
		odm_set_bb_reg_22b(dm, 0x800, BIT(10), 1);	/*ADC_mask disable*/
		odm_set_bb_reg_22b(dm, 0x800, BIT(10), 0);	/*ADC_mask enable*/
	}
#endif
	...
	if (adaptivity->dynamic_link_adaptivity && (!dm->is_linked) && !dm->adaptivity_enable) {
		phydm_set_edcca_threshold_22b(dm, 0x7f, 0x7f);
	...
	if (dm->adaptivity_enable == true)
		odm_set_mac_reg_22b(dm, REG_RD_CTRL, BIT(11), 1);
...
)
{
	...
	if (is_pasue_edcca) {
		...
		/*Disable EDCCA*/
#if (DM_ODM_SUPPORT_TYPE == ODM_WIN)
		if (odm_is_work_item_scheduled(&adaptivity->phydm_pause_edcca_22b_work_item) == false)
			odm_schedule_work_item(&adaptivity->phydm_pause_edcca_22b_work_item);
#else
		phydm_pause_edcca_22b_work_item_callback(dm);
#endif
...
#else
		phydm_resume_edcca_work_item_callback_22b(dm);
#endif
...
)
{
	...
	if (dm->support_ic_type & ODM_IC_11N_SERIES)
		odm_set_bb_reg_22b(dm, REG_OFDM_0_ECCA_THRESHOLD, MASKBYTE2 | MASKBYTE0, (u32)(0x7f | 0x7f << 16));
#if (RTL8195A_SUPPORT == 0)
	else if (dm->support_ic_type & ODM_IC_11AC_SERIES)
		odm_set_bb_reg_22b(dm, REG_FPGA0_XB_LSSI_READ_BACK, MASKLWORD, (u16)(0x7f | 0x7f << 8));
#endif
...
)
{
	...
	if (dm->support_ic_type & ODM_IC_11N_SERIES)
		odm_set_bb_reg_22b(dm, REG_OFDM_0_ECCA_THRESHOLD, MASKBYTE2 | MASKBYTE0, (u32)((u8)adaptivity->backup_l2h | (u8)adaptivity->backup_h2l << 16));
#if (RTL8195A_SUPPORT == 0)
	else if (dm->support_ic_type & ODM_IC_11AC_SERIES)
		odm_set_bb_reg_22b(dm, REG_FPGA0_XB_LSSI_READ_BACK, MASKLWORD, (u16)((u8)adaptivity->backup_l2h | (u8)adaptivity->backup_h2l << 8));
#endif
...
)
{
	...
	if (dm_value[0] == PHYDM_ADAPT_DEBUG) {
		...
		PDM_SNPF(out_len, used, output + used, out_len - used,
			       ...
			       dm->th_l2h_ini);
		if (dm->support_ic_type & ODM_IC_11N_SERIES) {
			reg_value32 = odm_get_bb_reg_22b(dm, 0xc4c, MASKDWORD);
			h2l_diff = (s8)(0x000000ff & reg_value32) - (s8)((0x00ff0000 & reg_value32)>>16);
		}
#if (RTL8195A_SUPPORT == 0)
		else if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
			reg_value32 = odm_get_bb_reg_22b(dm, 0x8a4, MASKDWORD);
...
)
{
	...
	if (dm->support_ic_type & (ODM_RTL8821C | ODM_RTL8822B | ODM_RTL8814A))
		odm_set_bb_reg_22b(dm, 0x8a0, BIT(1) | BIT(0), 0);
}
...
)
{
	...
	if (dm->support_ability & ODM_BB_ADAPTIVITY) {
		if (dm->support_ic_type & ODM_RTL8822B)
			odm_set_bb_reg_22b(dm, 0x8dc, BIT(5), 0x1);
		else if (dm->support_ic_type & ODM_RTL8197F)
			odm_set_bb_reg_22b(dm, 0xce8, BIT(13), 0x1);
	} else {
		if (dm->support_ic_type & ODM_RTL8822B)
			odm_set_bb_reg_22b(dm, 0x8dc, BIT(5), 0x0);
		else if (dm->support_ic_type & ODM_RTL8197F)
			odm_set_bb_reg_22b(dm, 0xce8, BIT(13), 0x0);
	}
}
...
)
{
	...
	phydm_set_edcca_threshold_22b(dm, (s8)val_buf[1], (s8)val_buf[0]);
}
