...
)
{
	...
	current_channel = odm_get_rf_reg_22b(dm, RF_PATH_A, ODM_CHANNEL, RFREGOFFSETMASK);
	rf_loop_reg = odm_get_rf_reg_22b(dm, RF_PATH_A, 0x00, RFREGOFFSETMASK);
	if (dm->support_ic_type & ODM_RTL8723B) {
		reg92c = odm_get_bb_reg_22b(dm, REG_DPDT_CONTROL, MASKDWORD);
		reg930 = odm_get_bb_reg_22b(dm, rfe_ctrl_anta_src, MASKDWORD);
		reg948 = odm_get_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, MASKDWORD);
		regb2c = odm_get_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, MASKDWORD);
		reg064 = odm_get_mac_reg_22b(dm, REG_SYM_WLBT_PAPE_SEL, BIT(29));
		odm_set_bb_reg_22b(dm, REG_DPDT_CONTROL, 0x3, 0x1);
		odm_set_bb_reg_22b(dm, rfe_ctrl_anta_src, 0xff, 0x77);
		odm_set_mac_reg_22b(dm, REG_SYM_WLBT_PAPE_SEL, BIT(29), 0x1);  /* dbg 7 */
		odm_set_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, 0x3c0, 0x0);/* dbg 8 */
		odm_set_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, BIT(31), 0x0);
	}

	ODM_delay_us_22b(10);

	/* Store A path Register 88c, c08, 874, c50 */
	reg88c = odm_get_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, MASKDWORD);
	regc08 = odm_get_bb_reg_22b(dm, REG_OFDM_0_TR_MUX_PAR, MASKDWORD);
	reg874 = odm_get_bb_reg_22b(dm, REG_FPGA0_XCD_RF_INTERFACE_SW, MASKDWORD);
	regc50 = odm_get_bb_reg_22b(dm, REG_OFDM_0_XA_AGC_CORE1, MASKDWORD);

	/* Store AFE Registers */
	if (dm->support_ic_type & ODM_RTL8723B)
		afe_rrx_wait_cca = odm_get_bb_reg_22b(dm, REG_RX_WAIT_CCA, MASKDWORD);

	/* Set PSD 128 pts */
	odm_set_bb_reg_22b(dm, REG_FPGA0_PSD_FUNCTION, BIT(14) | BIT15, 0x0); /* 128 pts */

	/* To SET CH1 to do */
	odm_set_rf_reg_22b(dm, RF_PATH_A, ODM_CHANNEL, RFREGOFFSETMASK, 0x7401);     /* channel 1 */

	/* AFE all on step */
	if (dm->support_ic_type & ODM_RTL8723B)
		odm_set_bb_reg_22b(dm, REG_RX_WAIT_CCA, MASKDWORD, 0x01c00016);

	/* 3 wire Disable */
	odm_set_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, MASKDWORD, 0xCCF000C0);

	/* BB IQK setting */
	odm_set_bb_reg_22b(dm, REG_OFDM_0_TR_MUX_PAR, MASKDWORD, 0x000800E4);
	odm_set_bb_reg_22b(dm, REG_FPGA0_XCD_RF_INTERFACE_SW, MASKDWORD, 0x22208000);

	/* IQK setting tone@ 4.34Mhz */
	odm_set_bb_reg_22b(dm, REG_TX_IQK_TONE_A, MASKDWORD, 0x10008C1C);
	odm_set_bb_reg_22b(dm, REG_TX_IQK, MASKDWORD, 0x01007c00);

	/* Page B init */
	odm_set_bb_reg_22b(dm, REG_CONFIG_ANT_A, MASKDWORD, 0x00080000);
	odm_set_bb_reg_22b(dm, REG_CONFIG_ANT_A, MASKDWORD, 0x0f600000);
	odm_set_bb_reg_22b(dm, REG_RX_IQK, MASKDWORD, 0x01004800);
	odm_set_bb_reg_22b(dm, REG_RX_IQK_TONE_A, MASKDWORD, 0x10008c1f);
	if (dm->support_ic_type & ODM_RTL8723B) {
		odm_set_bb_reg_22b(dm, REG_TX_IQK_PI_A, MASKDWORD, 0x82150016);
		odm_set_bb_reg_22b(dm, REG_RX_IQK_PI_A, MASKDWORD, 0x28150016);
	}
	odm_set_bb_reg_22b(dm, REG_IQK_AGC_RSP, MASKDWORD, 0x001028d0);
	odm_set_bb_reg_22b(dm, REG_OFDM_0_XA_AGC_CORE1, 0x7f, initial_gain);

	/* IQK Single tone start */
	odm_set_bb_reg_22b(dm, REG_FPGA0_IQK, 0xffffff00, 0x808000);
	odm_set_bb_reg_22b(dm, REG_IQK_AGC_PTS, MASKDWORD, 0xf9000000);
	odm_set_bb_reg_22b(dm, REG_IQK_AGC_PTS, MASKDWORD, 0xf8000000);
	...
	PSD_report_tmp = 0x0;
	for (n = 0; n < 2; n++) {
		PSD_report_tmp = phydm_get_psd_data_22b(dm, 14, initial_gain);
	...
	/* change to Antenna B */
	if (dm->support_ic_type & ODM_RTL8723B) {
		/* odm_set_bb_reg_22b(dm, REG_DPDT_CONTROL, 0x3, 0x2); */
		odm_set_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, 0xfff, 0x280);
		odm_set_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, BIT(31), 0x1);
	}
	...
	odm_set_bb_reg_22b(dm, REG_FPGA0_IQK, 0xffffff00, 0x000000);

	/* 1 Return to antanna A */
	if (dm->support_ic_type & ODM_RTL8723B) {
		/* external DPDT */
		odm_set_bb_reg_22b(dm, REG_DPDT_CONTROL, MASKDWORD, reg92c);

		/* internal S0/S1 */
		odm_set_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, MASKDWORD, reg948);
		odm_set_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, MASKDWORD, regb2c);
		odm_set_bb_reg_22b(dm, rfe_ctrl_anta_src, MASKDWORD, reg930);
		odm_set_mac_reg_22b(dm, REG_SYM_WLBT_PAPE_SEL, BIT(29), reg064);
	}

	odm_set_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, MASKDWORD, reg88c);
	odm_set_bb_reg_22b(dm, REG_OFDM_0_TR_MUX_PAR, MASKDWORD, regc08);
	odm_set_bb_reg_22b(dm, REG_FPGA0_XCD_RF_INTERFACE_SW, MASKDWORD, reg874);
	odm_set_bb_reg_22b(dm, REG_OFDM_0_XA_AGC_CORE1, 0x7F, 0x40);
	odm_set_bb_reg_22b(dm, REG_OFDM_0_XA_AGC_CORE1, MASKDWORD, regc50);
	odm_set_rf_reg_22b(dm, RF_PATH_A, RF_CHNLBW, RFREGOFFSETMASK, current_channel);
	odm_set_rf_reg_22b(dm, RF_PATH_A, 0x00, RFREGOFFSETMASK, rf_loop_reg);

	/* Reload AFE Registers */
	if (dm->support_ic_type & ODM_RTL8723B)
		odm_set_bb_reg_22b(dm, REG_RX_WAIT_CCA, MASKDWORD, afe_rrx_wait_cca);
...
)
{
	...
	/* if(HP id) */
	{
		...
		if (dm->support_ic_type == ODM_RTL8723B) {
			if (dm_swat_table->swas_no_link_bk_reg948 == 0xff)
				dm_swat_table->swas_no_link_bk_reg948 = odm_read_4byte_22b(dm, REG_S0_S1_PATH_SWITCH);
		}
	}
	...
	odm_acquire_spin_lock_22b(dm, RT_RF_STATE_SPINLOCK);
	if (hal_data->eRFPowerState != eRfOn || mgnt_info->RFChangeInProgress || mgnt_info->bMediaConnect) {
		odm_release_spin_lock_22b(dm, RT_RF_STATE_SPINLOCK);
	...
	if (dm_swat_table->swas_no_link_state == 0) {
		...
		if (dm->support_ic_type & (ODM_RTL8188E | ODM_RTL8821)) {
			...
			tmp_swas_no_link_bk_reg948 = odm_read_4byte_22b(dm, REG_S0_S1_PATH_SWITCH);
		...
		if (dm->support_ic_type & (ODM_RTL8188E | ODM_RTL8821)) {
			...
			if (dm->dm_swat_table.ANTB_ON == false)
				odm_set_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, 0xfff, (dm_swat_table->swas_no_link_bk_reg948));
...
)
{
	...
	channel_ori = odm_get_rf_reg_22b(dm, RF_PATH_A, ODM_CHANNEL, RFREGOFFSETMASK);
	reg948 = odm_get_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, MASKDWORD);
	regb2c =  odm_get_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, MASKDWORD);
	regc50 = odm_get_bb_reg_22b(dm, REG_OFDM_0_XA_AGC_CORE1, MASKDWORD);
	regc14 = odm_get_bb_reg_22b(dm, 0xc14, MASKDWORD);
	reg908 = odm_get_bb_reg_22b(dm, 0x908, MASKDWORD);

	/* 2 [ setting for doing PSD function (CH4)] */
	odm_set_bb_reg_22b(dm, REG_FPGA0_RFMOD, BIT(24), 0); /* disable whole CCK block */
	odm_write_1byte_22b(dm, REG_TXPAUSE, 0xFF); /* Turn off TX  ->  Pause TX Queue */
	odm_set_bb_reg_22b(dm, 0xC14, MASKDWORD, 0x0); /* [ Set IQK Matrix = 0 ] equivalent to [ Turn off CCA] */

	/* PHYTXON while loop */
	odm_set_bb_reg_22b(dm, 0x908, MASKDWORD, 0x803);
	while (odm_get_bb_reg_22b(dm, 0xdf4, BIT(6))) {
		i++;
		if (i > 1000000) {
	...
	odm_set_bb_reg_22b(dm, 0xc50, 0x7f, initial_gain);
	odm_set_rf_reg_22b(dm, RF_PATH_A, ODM_CHANNEL, 0x7ff, 0x04);     /* Set RF to CH4 & 40M */
	odm_set_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, 0xf00000, 0xf);	/* 3 wire Disable    88c[23:20]=0xf */
	odm_set_bb_reg_22b(dm, REG_FPGA0_PSD_FUNCTION, BIT(14) | BIT15, 0x0);  /* 128 pt	 */ /* Set PSD 128 ptss */
	...
	odm_set_bb_reg_22b(dm, 0x948, 0xfff, 0x200);
	ODM_delay_us_22b(10);
	PHYDM_DBG(dm, DBG_ANT_DIV, "dbg\n");
	for (i = 0; i < test_num; i++) {
		for (tone_idx = 0; tone_idx < tone_lenth_1; tone_idx++) {
			PSD_report_temp = phydm_get_psd_data_22b(dm, tone_idx_1[tone_idx], initial_gain);
	...
	odm_set_bb_reg_22b(dm, 0x948, 0xfff, 0x280);
	ODM_delay_us_22b(10);
	for (i = 0; i < test_num; i++) {
		for (tone_idx = 0; tone_idx < tone_lenth_1; tone_idx++) {
			PSD_report_temp = phydm_get_psd_data_22b(dm, tone_idx_1[tone_idx], initial_gain);
	...
	odm_set_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, 0xf00000, 0x0);	/* 3 wire enable    88c[23:20]=0x0 */
	ODM_delay_us_22b(3000);

	odm_set_bb_reg_22b(dm, 0xc50, 0x7f, initial_gain);
	odm_set_rf_reg_22b(dm, RF_PATH_A, ODM_CHANNEL, 0x7ff, 0x04);     /* Set RF to CH8 & 40M */
	...
	for (i = 0; i < test_num; i++) {
		for (tone_idx = 0; tone_idx < tone_lenth_2; tone_idx++) {
			PSD_report_temp = phydm_get_psd_data_22b(dm, tone_idx_2[tone_idx], initial_gain);
			/* if(  PSD_report_temp>psd_report_main[tone_idx]  ) */
	...
	odm_set_rf_reg_22b(dm, RF_PATH_A, RF_CHNLBW, RFREGOFFSETMASK, channel_ori);
	odm_set_bb_reg_22b(dm, REG_FPGA0_ANALOG_PARAMETER4, 0xf00000, 0x0);	/* 3 wire enable    88c[23:20]=0x0 */
	odm_set_bb_reg_22b(dm, 0xc50, 0x7f, regc50);

	odm_set_bb_reg_22b(dm, REG_S0_S1_PATH_SWITCH, MASKDWORD, reg948);
	odm_set_bb_reg_22b(dm, REG_AGC_TABLE_SELECT, MASKDWORD, regb2c);

	odm_set_bb_reg_22b(dm, REG_FPGA0_RFMOD, BIT(24), 1); /* enable whole CCK block */
	odm_write_1byte_22b(dm, REG_TXPAUSE, 0x0); /* Turn on TX	 */ /* Resume TX Queue */
	odm_set_bb_reg_22b(dm, 0xC14, MASKDWORD, regc14); /* [ Set IQK Matrix = 0 ] equivalent to [ Turn on CCA] */
	odm_set_bb_reg_22b(dm, 0x908, MASKDWORD, reg908);
