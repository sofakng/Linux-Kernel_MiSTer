...
)
{
	...
	if (enable_rxagc_switch == true) {
		if ((*dm->channel >= 36) && (*dm->channel <= 64)) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x1);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x5);
		} else if ((*dm->channel >= 100) && (*dm->channel <= 144)) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x2);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x6);
		} else if (*dm->channel >= 149) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x3);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x7);
		}
		...
		if ((*dm->channel >= 36) && (*dm->channel <= 64)) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x1);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x1);
		} else if ((*dm->channel >= 100) && (*dm->channel <= 144)) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x2);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x2);
		} else if (*dm->channel >= 149) {
			odm_set_bb_reg_22b(dm, 0x958, BIT(4), 0x1);
			odm_set_bb_reg_22b(dm, 0xc1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x3);
			odm_set_bb_reg_22b(dm, 0xe1c, (BIT(11)|BIT(10)|BIT(9)|BIT(8)), 0x3);
		}
...
)
{
	...
	igi = odm_get_bb_reg_22b(dm, 0xc50, 0x7f);
	odm_set_bb_reg_22b(dm, 0xc50, 0x7f, (igi - 2));
	odm_set_bb_reg_22b(dm, 0xc50, 0x7f, igi);
	odm_set_bb_reg_22b(dm, 0xe50, 0x7f, (igi - 2));
	odm_set_bb_reg_22b(dm, 0xe50, 0x7f, igi);
}
...
)
{
	if (channel <= 14) {
			/* signal source */
			odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x777777);
			odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x777777);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x77);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x77);
		
	} else if ((channel > 35) && (channel <= 64)) {
			/* signal source */
			odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x777747);
			odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x777747);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE0, 0x57);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE0, 0x57);
				
	} else if (channel > 64) {
			/* signal source */
			odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x777747);
			odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x777747);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE0, 0x75);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE0, 0x75);

	} else
			return;
	
	/* inverse or not */
	odm_set_bb_reg_22b(dm, 0xcbc, 0x3f, 0x0);
	odm_set_bb_reg_22b(dm, 0xcbc, (BIT(11) | BIT(10) | BIT(9) | BIT(8)), 0x0);
	odm_set_bb_reg_22b(dm, 0xebc, 0x3f, 0x0);
	odm_set_bb_reg_22b(dm, 0xebc, (BIT(11) | BIT(10) | BIT(9) | BIT(8)), 0x0);
	...
	if (channel <= 14) {
		if ((dm->rx_ant_status == BB_PATH_AB) || (dm->tx_ant_status == BB_PATH_AB)) {
			/* 2TX or 2RX */
			odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xa501);
			odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xa501);
		} else if (dm->rx_ant_status == dm->tx_ant_status) {
			/* TXA+RXA or TXB+RXB */
			odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xa500);
			odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xa500);
		} else {
			/* TXB+RXA or TXA+RXB */
			odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xa005);
			odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xa005);
		}
	} else if (channel > 35) {
		odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xa5a5);
		odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xa5a5);
	}
...
)
{
	...
	if(rfe_num > 11) {
	 ...
	 /*[Path_mux_sel]*/
	odm_set_bb_reg_22b(dm, 0x1990, BIT(rfe_num), ((path_mux_sel == BB_PATH_A) ? 0 : 1));
	 
	/*[Inv_en]*/
	odm_set_bb_reg_22b(dm, 0xcbc, BIT(rfe_num), (u32)inv_en);
	odm_set_bb_reg_22b(dm, 0xebc, BIT(rfe_num), (u32)inv_en);

	/*[Output Source Signal Selection]*/
	if (rfe_num <= 7) {
		odm_set_bb_reg_22b(dm, 0xcb0, ((0xf)<<(rfe_num * 4)), (u32)source_sel);
		odm_set_bb_reg_22b(dm, 0xeb0, ((0xf)<<(rfe_num * 4)), (u32)source_sel);
	} else {
		odm_set_bb_reg_22b(dm, 0xcb4, ((0xf)<<((rfe_num - 8) * 4)), (u32)source_sel);
		odm_set_bb_reg_22b(dm, 0xeb4, ((0xf)<<((rfe_num - 8) * 4)), (u32)source_sel);
	}
}
...
)
{
	...
	/* chip top mux */
	odm_set_bb_reg_22b(dm, 0x64, BIT(29) | BIT(28), 0x3);
	odm_set_bb_reg_22b(dm, 0x4c, BIT(26) | BIT(25), 0x0);
	odm_set_bb_reg_22b(dm, 0x40, BIT(2), 0x1);

	/* from s0 or s1 */
	odm_set_bb_reg_22b(dm, 0x1990, 0x3f, 0x30);
	odm_set_bb_reg_22b(dm, 0x1990, (BIT(11) | BIT(10)), 0x3);

	/* input or output */
	odm_set_bb_reg_22b(dm, 0x974, 0x3f, 0x3f);
	odm_set_bb_reg_22b(dm, 0x974, (BIT(11) | BIT(10)), 0x3);
}
...
)
{
	...
	if ((rfe_type == 4) || (rfe_type == 11)) {
		...
		/*odm_set_bb_reg_22b(dm, 0x804, (BIT(1)|BIT(0)), 0x0);*/
		/* Default setting is in PHY parameters */

		if (is_channel_2g) {
			/* signal source */
			odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x745774);
			odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x745774);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x57);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x57);

			/* inverse or not */
			odm_set_bb_reg_22b(dm, 0xcbc, 0x3f, 0x8);
			odm_set_bb_reg_22b(dm, 0xcbc, (BIT(11) | BIT(10)), 0x2);
			odm_set_bb_reg_22b(dm, 0xebc, 0x3f, 0x8);
			odm_set_bb_reg_22b(dm, 0xebc, (BIT(11) | BIT(10)), 0x2);

			/* antenna switch table */
			if ((dm->rx_ant_status == BB_PATH_AB) || (dm->tx_ant_status == BB_PATH_AB)) {
				/* 2TX or 2RX */
				odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xf050);
				odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xf050);
			} else if (dm->rx_ant_status == dm->tx_ant_status) {
				/* TXA+RXA or TXB+RXB */
				odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xf055);
				odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xf055);
			} else {
				/* TXB+RXA or TXA+RXB */
				odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xf550);
				odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xf550);
			}

		} else {
			/* signal source */
			odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x477547);
			odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x477547);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x75);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x75);

			/* inverse or not */
			odm_set_bb_reg_22b(dm, 0xcbc, 0x3f, 0x0);
			odm_set_bb_reg_22b(dm, 0xcbc, (BIT(11) | BIT(10)), 0x0);
			odm_set_bb_reg_22b(dm, 0xebc, 0x3f, 0x0);
			odm_set_bb_reg_22b(dm, 0xebc, (BIT(11) | BIT(10)), 0x0);
		...
		if ((dm->cut_version == ODM_CUT_B) && (rfe_type < 2)) {
			if (is_channel_2g) {
				/* signal source */
				odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x704570);
				odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x704570);
				odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x45);
				odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x45);
			} else {
				odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x174517);
				odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x174517);
				odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x45);
				odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x45);
			}

			/* delay 400ns for PAPE */
			odm_set_bb_reg_22b(dm, 0x810, 0xfff00000, 0x211);

			/* antenna switch table */
			odm_set_bb_reg_22b(dm, 0xca0, MASKLWORD, 0xa555);
			odm_set_bb_reg_22b(dm, 0xea0, MASKLWORD, 0xa555);
			...
			if (is_channel_2g) {
				/* signal source */
				odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x705770);
				odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x705770);
				odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x57);
				odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x57);
				odm_set_bb_reg_22b(dm, 0xcb8, BIT(4), 0);
				odm_set_bb_reg_22b(dm, 0xeb8, BIT(4), 0);
			} else {
				/* signal source */
				odm_set_bb_reg_22b(dm, 0xcb0, 0xffffff, 0x177517);
				odm_set_bb_reg_22b(dm, 0xeb0, 0xffffff, 0x177517);
				odm_set_bb_reg_22b(dm, 0xcb4, MASKBYTE1, 0x75);
				odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x75);
				odm_set_bb_reg_22b(dm, 0xcb8, BIT(5), 0);
				odm_set_bb_reg_22b(dm, 0xeb8, BIT(5), 0);
			}
			...
			/* delay 400ns for PAPE */
			/* odm_set_bb_reg_22b(dm, 0x810, MASKBYTE3|BIT20|BIT21|BIT22|BIT23, 0x211); */
		...
		if (is_channel_2g) {
			...
			odm_set_bb_reg_22b(dm, 0xcb0, MASKDWORD, 0x77178519);
			//odm_set_bb_reg_22b(dm, 0xeb0, MASKDWORD, 0x77177517);
			odm_set_bb_reg_22b(dm, 0xeb0, MASKDWORD, 0x771c7517);
			odm_set_bb_reg_22b(dm, 0xcb4, MASKDWORD, 0x757a);
			//odm_set_bb_reg_22b(dm, 0xeb4, MASKBYTE1, 0x7577);
			odm_set_bb_reg_22b(dm, 0xeb4, MASKDWORD, 0xd5e7);

			/* inverse or not */
			odm_set_bb_reg_22b(dm, 0xcbc, 0xfff, 0x0);
			odm_set_bb_reg_22b(dm, 0xebc, 0xfff, 0x0);
			#else
...
)
{
	...
	if (dm->cut_version == ODM_CUT_B) {
		odm_move_memory_22b(dm, cca_efem, cca_efem_bcut, 12 * 4);
		odm_move_memory_22b(dm, cca_ifem, cca_ifem_bcut, 12 * 4);
		PHYDM_DBG(dm, ODM_PHY_CONFIG, "%s: Update CCA parameters for Bcut\n", __func__);
	} else
#endif
	{
		odm_move_memory_22b(dm, cca_efem, cca_efem_ccut, 12 * 4);
	if ((dm->rfe_type == 3) || (dm->rfe_type == 5) || (dm->rfe_type == 12) || (dm->rfe_type == 15) || (dm->rfe_type == 16) || (dm->rfe_type == 17)) {
		odm_move_memory_22b(dm, cca_ifem, cca_ifem_ccut_rfetype, 12 * 4);
		is_rfe_type = true;
	} else
		odm_move_memory_22b(dm, cca_ifem, cca_ifem_ccut, 12 * 4);
	...
	odm_set_bb_reg_22b(dm, 0x82c, MASKDWORD, reg82c);

	if (is_ifem_cca == true)
		if (((dm->cut_version == ODM_CUT_B) && (col == 1 || col == 3) && (bw_8822b == CHANNEL_WIDTH_40)) ||
			((is_rfe_type == false) && (col == 3) && (bw_8822b == CHANNEL_WIDTH_40)) ||
			((dm->rfe_type == 5) && (col == 3)))
			odm_set_bb_reg_22b(dm, 0x830, MASKDWORD, 0x79a0ea28);
		else
			odm_set_bb_reg_22b(dm, 0x830, MASKDWORD, reg830);
	else
		odm_set_bb_reg_22b(dm, 0x830, MASKDWORD, reg830);

	odm_set_bb_reg_22b(dm, 0x838, MASKDWORD, reg838);

	if ((is_efem_cca == true) && !(dm->cut_version == ODM_CUT_B))
		odm_set_bb_reg_22b(dm, 0x83c, MASKDWORD, 0x9194b2b9);

	/* enlarge big jump size in type 16 for MS case */
	if ((dm->rfe_type == 16) && (central_ch_8822b <= 14))
		odm_set_bb_reg_22b(dm, 0x8c8, BIT(3) | BIT (2) | BIT(1), 0x3);
...
)
{
	if (bandwidth == CHANNEL_WIDTH_40) {
		/* RX DFIR for BW40 */
		odm_set_bb_reg_22b(dm, 0x948, BIT(29) | BIT(28), 0x1);
		odm_set_bb_reg_22b(dm, 0x94c, BIT(29) | BIT(28), 0x0);
		odm_set_bb_reg_22b(dm, 0xc20, BIT(31), 0x0);
		odm_set_bb_reg_22b(dm, 0xe20, BIT(31), 0x0);
	} else if (bandwidth == CHANNEL_WIDTH_80) {
		/* RX DFIR for BW80 */
		odm_set_bb_reg_22b(dm, 0x948, BIT(29) | BIT(28), 0x2);
		odm_set_bb_reg_22b(dm, 0x94c, BIT(29) | BIT(28), 0x1);
		odm_set_bb_reg_22b(dm, 0xc20, BIT(31), 0x0);
		odm_set_bb_reg_22b(dm, 0xe20, BIT(31), 0x0);
	} else {
		/* RX DFIR for BW20, BW10 and BW5*/
		odm_set_bb_reg_22b(dm, 0x948, BIT(29) | BIT(28), 0x2);
		odm_set_bb_reg_22b(dm, 0x94c, BIT(29) | BIT(28), 0x2);
		odm_set_bb_reg_22b(dm, 0xc20, BIT(31), 0x1);
		odm_set_bb_reg_22b(dm, 0xe20, BIT(31), 0x1);
	}
...
)
{
	...
	odm_set_bb_reg_22b(dm, (offset_txagc[path] + rate_idx), MASKDWORD, txagc_content);
...
)
{
	...
	if ((dm->rfe_type == 1) || (dm->rfe_type == 6) || (dm->rfe_type == 7)) {
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, (ODM_BOARD_EXT_LNA | ODM_BOARD_EXT_LNA_5G | ODM_BOARD_EXT_PA | ODM_BOARD_EXT_PA_5G));

		if (dm->rfe_type == 6) {
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GPA, (TYPE_GPA1 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_APA, (TYPE_APA1 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GLNA, (TYPE_GLNA1 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_ALNA, (TYPE_ALNA1 & (mask_path_a | mask_path_b)));
		} else if (dm->rfe_type == 7) {
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GPA, (TYPE_GPA2 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_APA, (TYPE_APA2 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GLNA, (TYPE_GLNA2 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_ALNA, (TYPE_ALNA2 & (mask_path_a | mask_path_b)));
		} else {
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GPA, (TYPE_GPA0 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_APA, (TYPE_APA0 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_GLNA, (TYPE_GLNA0 & (mask_path_a | mask_path_b)));
			odm_cmn_info_init_22b(dm, ODM_CMNINFO_ALNA, (TYPE_ALNA0 & (mask_path_a | mask_path_b)));
		}

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_PACKAGE_TYPE, 1);

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_LNA, true);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_LNA, true);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_PA, true);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_PA, true);
	} else if (dm->rfe_type == 2) {
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, (ODM_BOARD_EXT_LNA_5G | ODM_BOARD_EXT_PA_5G));
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_APA, (TYPE_APA0 & (mask_path_a | mask_path_b)));
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_ALNA, (TYPE_ALNA0 & (mask_path_a | mask_path_b)));

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_PACKAGE_TYPE, 2);

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_LNA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_LNA, true);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_PA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_PA, true);
	} else if (dm->rfe_type == 9) {
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, (ODM_BOARD_EXT_LNA_5G));
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_ALNA, (TYPE_ALNA0 & (mask_path_a | mask_path_b)));
		...
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_LNA, true);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_PA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_PA, false);
	} else if (dm->rfe_type == 3) {
		/* RFE type 3: 8822BS\8822BU TFBGA iFEM */
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, 0);

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_PACKAGE_TYPE, 2);

		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_LNA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_LNA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_EXT_PA, false);
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_5G_EXT_PA, false);
	} else if (dm->rfe_type == 5) {
		/* RFE type 5: 8822BE TFBGA iFEM */
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, ODM_BOARD_SLIM);
	...
	/* RFE type 10: QFN iFEM AP PCIE TRSW */
		odm_cmn_info_init_22b(dm, ODM_CMNINFO_BOARD_TYPE, ODM_BOARD_EXT_TRSW);
...
)
{
	...
	odm_set_bb_reg_22b(dm, 0x1988, BIT(22), 0x1);
	ret_val = (s32)odm_get_bb_reg_22b(dm, 0xf84, (BIT(17) | BIT(16) | MASKLWORD));
...
)
{
	...
	readback_value = odm_get_bb_reg_22b(dm, direct_addr, bit_mask);
...
)
{
	...
	/* Write operation */
	odm_set_bb_reg_22b(dm, offset_write_rf[path], MASKDWORD, data_and_addr);
...
)
{
	...
	odm_set_bb_reg_22b(dm, (offset_txagc[path] + rate_idx), MASKDWORD, power_index);
...
)
{
	...
	odm_set_bb_reg_22b(dm, 0x1998, BIT(16), 0x0);							/* need to check */

	/* Set data rate index (bit0~6) and path index (bit7) */
	odm_set_bb_reg_22b(dm, 0x1998, MASKBYTE0, (hw_rate | (path << 7)));

	/* Enable TXAGC report */
	odm_set_bb_reg_22b(dm, 0x1998, BIT(16), 0x1);

	/* Read TX AGC report */
	read_back_data = (u8)odm_get_bb_reg_22b(dm, 0xd30, 0x7f0000);

	/* Driver have to disable TXAGC report after reading TXAGC (ref. user guide v11) */
	odm_set_bb_reg_22b(dm, 0x1998, BIT(16), 0x0);
...
)
{
	...
	odm_set_bb_reg_22b(dm, 0x880, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x884, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x888, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x88c, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x890, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x894, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x898, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x89c, MASKDWORD, 0);
	odm_set_bb_reg_22b(dm, 0x874, BIT(0), 0x0);

	odm_set_bb_reg_22b(dm, 0x87c, BIT(13), 0x0);
	odm_set_bb_reg_22b(dm, 0xc20, BIT(28), 0x0);
	odm_set_bb_reg_22b(dm, 0xe20, BIT(28), 0x0);
	...
	for (k = 0; k < PSD_SMP_NUM; k++) {
		...
		for (j = 0; j < PSD_VAL_NUM; j++) {
			odm_set_bb_reg_22b(dm, 0xc00, MASKBYTE0, 0x4);/* disable 3-wire, path-A */
			odm_set_bb_reg_22b(dm, 0xe00, MASKBYTE0, 0x4);/* disable 3-wire, path-B */
			reg_910_15_12 = odm_get_bb_reg_22b(dm, 0x910, (BIT(15) | BIT(14) | BIT(13) | BIT(12)));

			if (dm->rx_ant_status & BB_PATH_A) {
				odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, (((BB_PATH_A)<<4) | BB_PATH_A));/*path-A*/

				if ((*dm->channel >= 1) && (*dm->channel <= 14))
					odm_set_bb_reg_22b(dm, 0x910, MASKDWORD, BIT(22) | freq_pt_2g_final);/* Start PSD */
				else
					odm_set_bb_reg_22b(dm, 0x910, MASKDWORD, BIT(22) | freq_pt_5g_final);/* Start PSD */

				ODM_delay_us_22b(500);

				psd_set[j] = odm_get_bb_reg_22b(dm, 0xf44, MASKLWORD);

				odm_set_bb_reg_22b(dm, 0x910, BIT(22), 0x0);/* turn off PSD */
			}

			if (dm->rx_ant_status & BB_PATH_B) {
				odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, (((BB_PATH_B)<<4) | BB_PATH_B));/*path-B*/

				if ((*dm->channel > 0) && (*dm->channel <= 14))
					odm_set_bb_reg_22b(dm, 0x910, MASKDWORD, BIT(22) | freq_pt_2g_b_final);/* Start PSD */
				else
					odm_set_bb_reg_22b(dm, 0x910, MASKDWORD, BIT(22) | freq_pt_5g_b_final);/* Start PSD */

				ODM_delay_us_22b(500);

				psd_set_B[j] = odm_get_bb_reg_22b(dm, 0xf44, MASKLWORD);

				odm_set_bb_reg_22b(dm, 0x910, BIT(22), 0x0);/* turn off PSD */
			}

			odm_set_bb_reg_22b(dm, 0xc00, MASKBYTE0, 0x7);/*eanble 3-wire*/
			odm_set_bb_reg_22b(dm, 0xe00, MASKBYTE0, 0x7);
			odm_set_bb_reg_22b(dm, 0x910, (BIT(15) | BIT(14) | BIT(13) | BIT(12)), reg_910_15_12);

			odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, (((dm->rx_ant_status)<<4) | dm->rx_ant_status));
		...
		if (dm->rx_ant_status & BB_PATH_A) {
			phydm_seq_sorting_22b(dm, psd_set, rank_psd_index_in, rank_psd_index_out, PSD_VAL_NUM);
			max_ret_psd_2nd[k] = psd_set[0];
		}
		if (dm->rx_ant_status & BB_PATH_B) {
			phydm_seq_sorting_22b(dm, psd_set_B, rank_psd_index_in, rank_psd_index_out, PSD_VAL_NUM);
			max_ret_psd_b_2nd[k] = psd_set_B[0];
		}
	}

	if (dm->rx_ant_status & BB_PATH_A) {
		phydm_seq_sorting_22b(dm, max_ret_psd_2nd, rank_sample_index_in, rank_sample_index_out, PSD_SMP_NUM);
	...
	if (dm->rx_ant_status & BB_PATH_B) {
		phydm_seq_sorting_22b(dm, max_ret_psd_b_2nd, rank_sample_index_in, rank_sample_index_out, PSD_SMP_NUM);
	...
	if (s_donbi_a == true || s_donbi_b == true) {
		if (*dm->band_width == CHANNEL_WIDTH_20) {
			if (*dm->channel == 153)
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 5760, PHYDM_DONT_CARE);
			else if (*dm->channel == 161)
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 5800, PHYDM_DONT_CARE);
			else if (*dm->channel >= 5 && *dm->channel <= 8)
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 2440, PHYDM_DONT_CARE);
			else if (*dm->channel == 13)
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 2480, PHYDM_DONT_CARE);
			else
				set_result_nbi = PHYDM_SET_NO_NEED;
		} else if (*dm->band_width == CHANNEL_WIDTH_40) {
			if (*dm->channel == 54) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5280, PHYDM_DONT_CARE);
			} else if (*dm->channel == 118) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5600, PHYDM_DONT_CARE);
			} else if (*dm->channel == 151) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5760, PHYDM_DONT_CARE);
			} else if (*dm->channel == 159) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5800, PHYDM_DONT_CARE);
				/* 2.4G */
			} else if ((*dm->channel >= 4) && (*dm->channel <= 6)) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 2440, PHYDM_DONT_CARE);
			} else if (*dm->channel == 11) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 2480, PHYDM_DONT_CARE);
			} else
				set_result_nbi = PHYDM_SET_NO_NEED;
		} else if (*dm->band_width == CHANNEL_WIDTH_80) {
			if (*dm->channel == 58) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 80, 5280, PHYDM_DONT_CARE);
			} else if (*dm->channel == 122) {
				set_result_nbi = phydm_nbi_setting_22b(dm, FUNC_ENABLE, *dm->channel, 80, 5600, PHYDM_DONT_CARE);
	...
	if (s_docsi == true) {
		if (*dm->band_width == CHANNEL_WIDTH_20) {
			if (*dm->channel == 153)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 5760, PHYDM_DONT_CARE);
			else if (*dm->channel == 161)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 5800, PHYDM_DONT_CARE);
			else if (*dm->channel >= 5 && *dm->channel <= 8)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 2440, PHYDM_DONT_CARE);
			else if (*dm->channel == 13)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 20, 2480, PHYDM_DONT_CARE);
			else
				set_result_csi = PHYDM_SET_NO_NEED;
		} else if (*dm->band_width == CHANNEL_WIDTH_40) {
			if (*dm->channel == 54)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5280, PHYDM_DONT_CARE);
			else if (*dm->channel == 118)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5600, PHYDM_DONT_CARE);
			else if (*dm->channel == 151)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5760, PHYDM_DONT_CARE);
			else if (*dm->channel == 159)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 5800, PHYDM_DONT_CARE);
			else if ((*dm->channel >= 3) && (*dm->channel <= 10))
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 2440, PHYDM_DONT_CARE);
			else if (*dm->channel == 11)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 40, 2480, PHYDM_DONT_CARE);
			else
				set_result_csi = PHYDM_SET_NO_NEED;
		} else if (*dm->band_width == CHANNEL_WIDTH_80) {
			if (*dm->channel == 58)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 80, 5280, PHYDM_DONT_CARE);
			else if (*dm->channel == 122)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 80, 5600, PHYDM_DONT_CARE);
			else if (*dm->channel == 155)
				set_result_csi = phydm_csi_mask_setting_22b(dm, FUNC_ENABLE, *dm->channel, 80, 5760, PHYDM_DONT_CARE);
			else
				set_result_csi = PHYDM_SET_NO_NEED;
		} else
			set_result_csi = PHYDM_SET_NO_NEED;
...
)
{
	...
	if (central_ch <= 14) {
		...
		/* Enable CCK block */
		odm_set_bb_reg_22b(dm, 0x808, BIT(28), 0x1);

		/* Disable MAC CCK check */
		odm_set_bb_reg_22b(dm, 0x454, BIT(7), 0x0);

		/* Disable BB CCK check */
		odm_set_bb_reg_22b(dm, 0xa80, BIT(18), 0x0);

		/*CCA Mask*/
		odm_set_bb_reg_22b(dm, 0x814, 0x0000FC00, 15); /*default value*/
		...
		reg_8 = odm_get_bb_reg_22b(dm, 0x19a8, BIT(31));
		...
		if (reg_8 == 0x1) {
			...
			if ((dm->rfe_type == 3) || (dm->rfe_type == 5) || (dm->rfe_type == 8) || (dm->rfe_type == 17)) {
				...
				odm_set_bb_reg_22b(dm, 0x8d8, BIT(19), 0x0);
		...
		/* Enable BB CCK check */
		odm_set_bb_reg_22b(dm, 0xa80, BIT(18), 0x1);

		/* Enable CCK check */
		odm_set_bb_reg_22b(dm, 0x454, BIT(7), 0x1);

		/* Disable CCK block */
		odm_set_bb_reg_22b(dm, 0x808, BIT(28), 0x0);

		/*CCA Mask*/
	#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
		odm_set_bb_reg_22b(dm, 0x814, 0x0000FC00, 34); /*CCA mask = 13.6us*/
	#else	
		if ((!dm->wifi_test))
			odm_set_bb_reg_22b(dm, 0x814, 0x0000FC00, 34); /*CCA mask = 13.6us*/
		else
	...
	odm_set_rf_reg_22b(dm, RF_PATH_A, 0x18, RFREGOFFSETMASK, rf_reg18);

	if (dm->rf_type > RF_1T1R)
		odm_set_rf_reg_22b(dm, RF_PATH_B, 0x18, RFREGOFFSETMASK, rf_reg18);
...
{
	struct phydm_dig_22b_struct		*dig_tab = &dm->dm_dig_table;
	...
	if (central_ch <= 14) {
		...
		odm_set_bb_reg_22b(dm, 0x958, 0x1f, 0x0);
		dig_tab->agc_table_idx = 0x0;

		/* 3. Set central frequency for clock offset tracking */
		odm_set_bb_reg_22b(dm, 0x860, 0x1ffe0000, 0x96a);

		/* CCK TX filter parameters */

		if (central_ch == 14) {
			odm_set_bb_reg_22b(dm, 0xa24, MASKDWORD, 0x00006577);
			odm_set_bb_reg_22b(dm, 0xa28, MASKLWORD, 0x0000);
		} else {
			odm_set_bb_reg_22b(dm, 0xa24, MASKDWORD, 0x384f6577);
			odm_set_bb_reg_22b(dm, 0xa28, MASKLWORD, 0x1525);
		}
		...
		if (!((dm->rfe_type == 15) || (dm->rfe_type == 16))) {
			if ((central_ch >= 36) && (central_ch <= 64)) {
				odm_set_bb_reg_22b(dm, 0x958, 0x1f, 0x1);
				dig_tab->agc_table_idx = 0x1;
			} else if ((central_ch >= 100) && (central_ch <= 144)) {
				odm_set_bb_reg_22b(dm, 0x958, 0x1f, 0x2);
				dig_tab->agc_table_idx = 0x2;
			} else if (central_ch >= 149) {
				odm_set_bb_reg_22b(dm, 0x958, 0x1f, 0x3);
		...
		if ((central_ch >= 36) && (central_ch <= 48))
			odm_set_bb_reg_22b(dm, 0x860, 0x1ffe0000, 0x494);
		else if ((central_ch >= 52) && (central_ch <= 64))
			odm_set_bb_reg_22b(dm, 0x860, 0x1ffe0000, 0x453);
		else if ((central_ch >= 100) && (central_ch <= 116))
			odm_set_bb_reg_22b(dm, 0x860, 0x1ffe0000, 0x452);
		else if ((central_ch >= 118) && (central_ch <= 177))
			odm_set_bb_reg_22b(dm, 0x860, 0x1ffe0000, 0x412);
		else {
	...
	if (*dm->mp_mode && ((dm->rfe_type == 3) || (dm->rfe_type == 5))) {
		if (central_ch == 14)
			odm_write_dig_22b(dm, 0x26);
		else
			odm_write_dig_22b(dm, 0x20);
	}
	...
	if (rf_reg_be != 0xff)
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xbe, (BIT(17) | BIT(16) | BIT(15)), rf_reg_be);
	else {
	...
	if (central_ch == 144) {
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xdf, BIT(18), 0x1);
		rf_reg18 = (rf_reg18 | BIT(17));
	} else {
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xdf, BIT(18), 0x0);
	...
	odm_set_rf_reg_22b(dm, RF_PATH_A, 0xb8, BIT(19), 0);
	odm_set_rf_reg_22b(dm, RF_PATH_A, 0xb8, BIT(19), 1);
...
)
{
	...
	case CHANNEL_WIDTH_20:
	{
		...
		/* odm_set_bb_reg_22b(dm, 0x8ac, MASKBYTE0, CHANNEL_WIDTH_20);*/

		/* ADC clock = 160M clock for BW20 */
		/* odm_set_bb_reg_22b(dm, 0x8ac, (BIT(9) | BIT(8)), 0x0);*/
		/* odm_set_bb_reg_22b(dm, 0x8ac, BIT(16), 0x1);*/

		/* DAC clock = 160M clock for BW20 */
		/* odm_set_bb_reg_22b(dm, 0x8ac, (BIT(21) | BIT(20)), 0x0);*/
		/* odm_set_bb_reg_22b(dm, 0x8ac, BIT(28), 0x1);*/

		val32 = odm_get_bb_reg_22b(dm, 0x8ac, MASKDWORD);
		val32 &= 0xFFCFFC00;
		val32 |= (CHANNEL_WIDTH_20);
		odm_set_bb_reg_22b(dm, 0x8ac, MASKDWORD, val32);

		/* ADC buffer clock */
		odm_set_bb_reg_22b(dm, 0x8c4, BIT(30), 0x1);
	...
	case CHANNEL_WIDTH_40:
	{
		...
		/* odm_set_bb_reg_22b(dm, 0x8ac, MASKBYTE0, (((primary_ch_idx & 0xf) << 2) | CHANNEL_WIDTH_40));*/

		/* CCK primary channel */
		if (primary_ch_idx == 1)
			odm_set_bb_reg_22b(dm, 0xa00, BIT(4), primary_ch_idx);
		else
			odm_set_bb_reg_22b(dm, 0xa00, BIT(4), 0);

		/* ADC clock = 160M clock for BW40 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(11) | BIT(10)), 0x0);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(17), 0x1);*/

		/* DAC clock = 160M clock for BW20 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(23) | BIT(22)), 0x0);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(29), 0x1);*/
	...
	case CHANNEL_WIDTH_80:
	{
		...
		/*odm_set_bb_reg_22b(dm, 0x8ac, MASKBYTE0, (((primary_ch_idx & 0xf) << 2) | CHANNEL_WIDTH_80));*/

		/* ADC clock = 160M clock for BW80 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(13) | BIT(12)), 0x0);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(18), 0x1);*/

		/* DAC clock = 160M clock for BW20 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(25) | BIT(24)), 0x0);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(30), 0x1);*/
		...
		if ((rfe_type == 2) || (rfe_type == 3) || (rfe_type == 17) ) {
			odm_set_bb_reg_22b(dm, 0x840, 0x0000f000, 0x6);
			odm_set_bb_reg_22b(dm, 0x8c8, BIT(10), 0x1);
		}
	...
	case CHANNEL_WIDTH_5:
	{
		...
		/* ADC clock = 40M clock */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(9) | BIT(8)), 0x2);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(16), 0x0);*/

		/* DAC clock = 160M clock for BW20 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(21) | BIT(20)), 0x2);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(28), 0x0);*/
		...
		/* ADC buffer clock */
		odm_set_bb_reg_22b(dm, 0x8c4, BIT(30), 0x0);
		odm_set_bb_reg_22b(dm, 0x8c8, BIT(31), 0x1);
	...
	{
		/* Small BW([7:6]) = 1, primary channel ([5:2]) = 0, rf mode([1:0]) = 20M */
		/*odm_set_bb_reg_22b(dm, 0x8ac, MASKBYTE0, (BIT(7) | CHANNEL_WIDTH_20));*/

		/* ADC clock = 80M clock */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(9) | BIT(8)), 0x3);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(16), 0x0);*/

		/* DAC clock = 160M clock for BW20 */
		/*odm_set_bb_reg_22b(dm, 0x8ac, (BIT(21) | BIT(20)), 0x3);*/
		/*odm_set_bb_reg_22b(dm, 0x8ac, BIT(28), 0x0);*/
	...
	odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, 0x0);
	odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, (dm->rx_ant_status | (dm->rx_ant_status << 4)));
...
)
{
	...
	if ((tx_path | rx_path) & BB_PATH_A)
		odm_set_bb_reg_22b(dm, 0xc08, MASKLWORD, 0x3231);
	else
		odm_set_bb_reg_22b(dm, 0xc08, MASKLWORD, 0x1111);

	if ((tx_path | rx_path) & BB_PATH_B)
		odm_set_bb_reg_22b(dm, 0xe08, MASKLWORD, 0x3231);
	else
		odm_set_bb_reg_22b(dm, 0xe08, MASKLWORD, 0x1111);

	/*[TX Antenna Setting] ==========================================*/
	
	/* Set TX antenna by Nsts */
	odm_set_bb_reg_22b(dm, 0x93c, (BIT(19) | BIT(18)), 0x3);
	odm_set_bb_reg_22b(dm, 0x80c, (BIT(29) | BIT(28)), 0x1);

	/* Control CCK TX path by 0xa07[7] */
	odm_set_bb_reg_22b(dm, 0x80c, BIT(30), 0x1);

	/* TX logic map and TX path en for Nsts = 1, and CCK TX path*/
	if (tx_path & BB_PATH_A) {
		odm_set_bb_reg_22b(dm, 0x93c, 0xfff00000, 0x001);
		odm_set_bb_reg_22b(dm, 0xa04, 0xf0000000, 0x8);
	} else if (tx_path & BB_PATH_B) {
		odm_set_bb_reg_22b(dm, 0x93c, 0xfff00000, 0x002);
		odm_set_bb_reg_22b(dm, 0xa04, 0xf0000000, 0x4);
	}
	...
	if ((tx_path == BB_PATH_A) || (tx_path == BB_PATH_B))
		odm_set_bb_reg_22b(dm, 0x940, 0xfff0, 0x01);
	else
		odm_set_bb_reg_22b(dm, 0x940, 0xfff0, 0x43);

	odm_set_bb_reg_22b(dm, 0x80c, MASKBYTE0, ((tx_path << 4) | tx_path));/* TX path HW block enable */

	/* Tx2path for 1ss */
	if (!((tx_path == BB_PATH_A) || (tx_path == BB_PATH_B))) {
		if (is_tx2_path || *dm->mp_mode) {
			
			odm_set_bb_reg_22b(dm, 0x93c, 0xfff00000, 0x043);	/* 2Tx for OFDM */
			odm_set_bb_reg_22b(dm, 0xa04, 0xf0000000, 0xc);	/* 2Tx for CCK */
		}
	}
	
	/*[RX Antenna Setting] ==========================================*/

	odm_set_bb_reg_22b(dm, 0xa2c, BIT(22), 0x0);	/*Disable MRC for CCK CCA */
	odm_set_bb_reg_22b(dm, 0xa2c, BIT(18), 0x0);	/*Disable MRC for CCK barker */

	/* CCK RX 1st and 2nd path setting*/
	if (rx_path & BB_PATH_A)
		odm_set_bb_reg_22b(dm, 0xa04, 0x0f000000, 0x0); /*00,00*/
	else if (rx_path & BB_PATH_B)
		odm_set_bb_reg_22b(dm, 0xa04, 0x0f000000, 0x5);/*01,01*/

	/* RX path enable */
	odm_set_bb_reg_22b(dm, 0x808, MASKBYTE0, ((rx_path << 4) | rx_path));

	if ((rx_path == BB_PATH_A) || (rx_path == BB_PATH_B)) {
		/* 1R */

		/* Disable MRC for CCA */
		/* odm_set_bb_reg_22b(dm, 0xa2c, BIT22, 0x0); */

		/* Disable MRC for barker */
		/* odm_set_bb_reg_22b(dm, 0xa2c, BIT18, 0x0); */

		/* Disable CCK antenna diversity */
		/* odm_set_bb_reg_22b(dm, 0xa00, BIT15, 0x0); */

		/* Disable Antenna weighting */
		odm_set_bb_reg_22b(dm, 0x1904, BIT(16), 0x0);	/*AntWgt_en*/
		odm_set_bb_reg_22b(dm, 0x800, BIT(28), 0x0);	/*htstf ant-wgt enable = 0*/
		odm_set_bb_reg_22b(dm, 0x850, BIT(23), 0x0);	/*MRC_mode  =  'original ZF eqz'*/
	} else {
		/* 2R */

		/* Enable MRC for CCA */
		/* odm_set_bb_reg_22b(dm, 0xa2c, BIT22, 0x1); */

		/* Enable MRC for barker */
		/* odm_set_bb_reg_22b(dm, 0xa2c, BIT18, 0x1); */

		/* Disable CCK antenna diversity */
		/* odm_set_bb_reg_22b(dm, 0xa00, BIT15, 0x0); */

		/* Enable Antenna weighting */
		odm_set_bb_reg_22b(dm, 0x1904, BIT(16), 0x1);	/*AntWgt_en*/
		odm_set_bb_reg_22b(dm, 0x800, BIT(28), 0x1);	/*htstf ant-wgt enable = 1*/
		odm_set_bb_reg_22b(dm, 0x850, BIT(23), 0x1);	/*MRC_mode =  'modified ZF eqz'*/
	}
	...
	while (1) {
		counter++;
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, RFREGOFFSETMASK, 0x80000);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x33, RFREGOFFSETMASK, 0x00001);
	...
	if (*dm->mp_mode || (*dm->antenna_test) || (dm->normal_rx_path)) {
		...
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, RFREGOFFSETMASK, 0x80000);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x33, RFREGOFFSETMASK, 0x00001);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x3e, RFREGOFFSETMASK, 0x00034);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x3f, RFREGOFFSETMASK, 0x4080e);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, RFREGOFFSETMASK, 0x00000);
		...
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x33, RFREGOFFSETMASK, 0x00001);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x3e, RFREGOFFSETMASK, 0x00034);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0x3f, RFREGOFFSETMASK, 0x4080c);
		odm_set_rf_reg_22b(dm, RF_PATH_A, 0xef, RFREGOFFSETMASK, 0x00000);
...
)
{
	if (type == ODM_PRE_SETTING) {
		odm_set_bb_reg_22b(dm, 0x808, (BIT(28) | BIT(29)), 0x0);
		PHYDM_DBG(dm, ODM_PHY_CONFIG, "%s: Pre setting: disable OFDM and CCK block\n", __func__);
	} else if (type == ODM_POST_SETTING) {
		odm_set_bb_reg_22b(dm, 0x808, (BIT(28) | BIT(29)), 0x3);
		...
		odm_fill_h2c_cmd_22b(dm, PHYDM_H2C_FW_GENERAL_INIT, 4, h2c_content);
#endif
	} else {
