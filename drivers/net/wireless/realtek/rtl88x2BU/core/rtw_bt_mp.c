...
void MPh2c_timeout_handle(void *FunctionContext)
{
	...
	if ((_FALSE == pMptCtx->MptH2cRspEvent)
		...
		_rtw_up_sema_22b(&pMptCtx->MPh2c_Sema);
}
...
u32 WaitC2Hevent(PADAPTER pAdapter, u8 *C2H_event, u32 delay_time)
{
	...
	_rtw_down_sema_22b(&pMptCtx->MPh2c_Sema);
...
)
{
	...
	/* _rtw_memcpy_22b(&pH2c->buf[0], pH2cPar, h2cParaLen); */
	_rtw_memcpy_22b(pH2c->buf, pH2cPar, h2cParaLen);
...
)
{
	...
	case EXT_C2H_TRIG_BY_BT_FW:
		...
		_rtw_memcpy_22b(&pMptCtx->c2hBuf[0], tmpBuf, length);
...
)
{
	...
	_rtw_memset_22b((void *)pMptCtx->mptOutBuf, 0, 100);
