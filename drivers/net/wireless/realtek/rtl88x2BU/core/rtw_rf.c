...
u8 center_ch_2g_22b[CENTER_CH_2G_NUM] = {
/* G00 */1, 2,
/* G01 */3, 4, 5,
/* G02 */6, 7, 8,
/* G03 */9, 10, 11,
...
u8 center_ch_2g_22b_40m_22b[CENTER_CH_2G_40M_NUM] = {
	3,
	4,
	5,
	6,
...
u8 op_chs_of_cch_2g_40m_22b[CENTER_CH_2G_40M_NUM][2] = {
	{1, 5}, /* 3 */
	{2, 6}, /* 4 */
	{3, 7}, /* 5 */
	{4, 8}, /* 6 */
...
u8 center_ch_5g_all_22b[CENTER_CH_5G_ALL_NUM] = {
/* G00 */36, 38, 40,
	42,
/* G01 */44, 46, 48,
	/* 50, */
...
u8 center_ch_5g_20m_22b[CENTER_CH_5G_20M_NUM] = {
/* G00 */36, 40,
/* G01 */44, 48,
/* G02 */52, 56,
/* G03 */60, 64,
...
u8 center_ch_5g_40m_22b[CENTER_CH_5G_40M_NUM] = {
/* G00 */38,
/* G01 */46,
/* G02 */54,
/* G03 */62,
...
u8 center_ch_5g_20m_22b_40m_22b[CENTER_CH_5G_20M_NUM + CENTER_CH_5G_40M_NUM] = {
/* G00 */36, 38, 40,
/* G01 */44, 46, 48,
/* G02 */52, 54, 56,
/* G03 */60, 62, 64,
...
u8 op_chs_of_cch_5g_40m_22b[CENTER_CH_5G_40M_NUM][2] = {
	{36, 40}, /* 38 */
	{44, 48}, /* 46 */
	{52, 56}, /* 54 */
	{60, 64}, /* 62 */
...
u8 center_ch_5g_80m_22b[CENTER_CH_5G_80M_NUM] = {
/* G00 ~ G01*/42,
/* G02 ~ G03*/58,
/* G04 ~ G05*/106,
/* G06 ~ G07*/122,
...
u8 op_chs_of_cch_5g_80m_22b[CENTER_CH_5G_80M_NUM][4] = {
	{36, 40, 44, 48}, /* 42 */
	{52, 56, 60, 64}, /* 58 */
	{100, 104, 108, 112}, /* 106 */
	{116, 120, 124, 128}, /* 122 */
...
u8 center_ch_5g_160m_22b[CENTER_CH_5G_160M_NUM] = {
/* G00 ~ G03*/50,
/* G04 ~ G07*/114,
/* G10 ~ G13*/163
};

u8 op_chs_of_cch_5g_160m_22b[CENTER_CH_5G_160M_NUM][8] = {
...
struct center_chs_ent_t center_chs_2g_22b_by_bw_22b[] = {
	{CENTER_CH_2G_NUM, center_ch_2g_22b},
	{CENTER_CH_2G_40M_NUM, center_ch_2g_22b_40m_22b},
};

struct center_chs_ent_t center_chs_5g_22b_by_bw_22b[] = {
	{CENTER_CH_5G_20M_NUM, center_ch_5g_20m_22b},
	{CENTER_CH_5G_40M_NUM, center_ch_5g_40m_22b},
	{CENTER_CH_5G_80M_NUM, center_ch_5g_80m_22b},
	{CENTER_CH_5G_160M_NUM, center_ch_5g_160m_22b},
};
...
struct op_chs_ent_t op_chs_of_cch_2g_by_bw_22b[] = {
	{1, center_ch_2g_22b},
	{2, (u8 *)op_chs_of_cch_2g_40m_22b},
};

struct op_chs_ent_t op_chs_of_cch_5g_by_bw_22b[] = {
	{1, center_ch_5g_20m_22b},
	{2, (u8 *)op_chs_of_cch_5g_40m_22b},
	{4, (u8 *)op_chs_of_cch_5g_80m_22b},
	{8, (u8 *)op_chs_of_cch_5g_160m_22b},
};

inline u8 center_chs_2g_22b_num_22b(u8 bw)
{
	if (bw > CHANNEL_WIDTH_40)
		return 0;

	return center_chs_2g_22b_by_bw_22b[bw].ch_num;
}

inline u8 center_chs_2g_22b(u8 bw, u8 id)
{
	if (bw > CHANNEL_WIDTH_40)
		return 0;

	if (id >= center_chs_2g_22b_num_22b(bw))
		return 0;

	return center_chs_2g_22b_by_bw_22b[bw].chs[id];
}

inline u8 center_chs_5g_22b_num_22b(u8 bw)
{
	if (bw > CHANNEL_WIDTH_80)
		return 0;

	return center_chs_5g_22b_by_bw_22b[bw].ch_num;
}

inline u8 center_chs_5g_22b(u8 bw, u8 id)
{
	if (bw > CHANNEL_WIDTH_80)
		return 0;

	if (id >= center_chs_5g_22b_num_22b(bw))
		return 0;

	return center_chs_5g_22b_by_bw_22b[bw].chs[id];
}
...
u8 rtw_get_op_chs_by_cch_bw_22b(u8 cch, u8 bw, u8 **op_chs, u8 *op_ch_num)
{
	...
	if (cch <= 14
		...
		c_chs_ent = &center_chs_2g_22b_by_bw_22b[bw];
		op_chs_ent = &op_chs_of_cch_2g_by_bw_22b[bw];
	} else if (cch >= 36 && cch <= 177
		&& bw >= CHANNEL_WIDTH_20 && bw <= CHANNEL_WIDTH_160
	) {
		c_chs_ent = &center_chs_5g_22b_by_bw_22b[bw];
		op_chs_ent = &op_chs_of_cch_5g_by_bw_22b[bw];
	} else {
		valid = 0;
		goto exit;
	}
...
const char *const _ch_width_str_22b[CHANNEL_WIDTH_MAX] = {
	"20MHz",
	"40MHz",
	"80MHz",
	"160MHz",
...
const u8 _ch_width_to_bw_cap_22b[CHANNEL_WIDTH_MAX] = {
	BW_CAP_20M,
	BW_CAP_40M,
	BW_CAP_80M,
	BW_CAP_160M,
...
const char *const _band_str_22b[] = {
	"2.4G",
	"5G",
	"BOTH",
	"BAND_MAX",
...
const u8 _band_to_band_cap_22b[] = {
	BAND_CAP_2G,
	BAND_CAP_5G,
	0,
	0,
...
const u8 _rf_type_to_rf_tx_cnt_22b[] = {
	1, /*RF_1T1R*/
	1, /*RF_1T2R*/
	2, /*RF_2T2R*/
	2, /*RF_2T3R*/
...
const u8 _rf_type_to_rf_rx_cnt_22b[] = {
	1, /*RF_1T1R*/
	2, /*RF_1T2R*/
	2, /*RF_2T2R*/
	3, /*RF_2T3R*/
...
/*
* rtw_get_chplan_from_country_22b -
* @country_code: string of country code
*
...
const struct country_chplan *rtw_get_chplan_from_country_22b(const char *country_code)
{
	...
	code[0] = alpha_to_upper_22b(country_code[0]);
	code[1] = alpha_to_upper_22b(country_code[1]);
...
const char *const _regd_str_22b[] = {
	"NONE",
	"FCC",
	"MKK",
	"ETSI",
...
chk_lmt_val:
	...
	if (pre_lmt != MAX_POWER_INDEX)
		RTW_PRINT("duplicate txpwr_lmt for [%s][%s][%s][%s][%uT][%d]\n"
			...
			, band == BAND_ON_2_4G ? ch_idx + 1 : center_ch_5g_all_22b[ch_idx]);
...
s8 rtw_rf_get_kfree_tx_gain_offset_22b(_adapter *padapter, u8 path, u8 ch)
{
	s8 kfree_offset = 0;
	...
	s8 bb_gain_sel = rtw_ch_to_bb_gain_sel_22b(ch);
...
void rtw_rf_apply_tx_gain_offset_22b(_adapter *adapter, u8 ch)
{
	...
	for (i = 0; i < total; i++) {
		kfree_offset = rtw_rf_get_kfree_tx_gain_offset_22b(adapter, i, ch);
		total_offset = kfree_offset + tx_pwr_track_offset;
		rtw_rf_set_tx_gain_offset_22b(adapter, i, total_offset);
	}
}

inline u8 rtw_is_dfs_range_22b(u32 hi, u32 lo)
{
...
u8 rtw_is_dfs_ch_22b(u8 ch)
{
	...
	if (!rtw_chbw_to_freq_range_22b(ch, CHANNEL_WIDTH_20, HAL_PRIME_CHNL_OFFSET_DONT_CARE, &hi, &lo))
		return 0;

	return rtw_is_dfs_range_22b(hi, lo);
}
...
u8 rtw_is_dfs_ch_22bbw(u8 ch, u8 bw, u8 offset)
{
	...
	if (!rtw_chbw_to_freq_range_22b(ch, bw, offset, &hi, &lo))
		return 0;
...
bool rtw_is_long_cac_ch_22b(u8 ch, u8 bw, u8 offset, u8 dfs_region)
{
	...
	return rtw_is_long_cac_range_22b(hi, lo, dfs_region) ? _TRUE : _FALSE;
}
