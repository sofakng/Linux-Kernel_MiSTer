...
u16 rtw_get_tx_rate_bmp_cck_ofdm_22b(struct dvobj_priv *dvobj);
u32 rtw_get_tx_rate_bmp_ht_by_bw_22b(struct dvobj_priv *dvobj, u8 bw);
u32 rtw_get_tx_rate_bmp_vht_by_bw_22b(struct dvobj_priv *dvobj, u8 bw);
...
extern struct xmit_frame *rtw_get_xframe_22b(struct xmit_priv *pxmitpriv, int *num_frame);
#endif
