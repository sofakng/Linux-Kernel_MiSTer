...
bool hal_chk_band_cap_22b(_adapter *adapter, u8 cap);
bool hal_chk_bw_cap_22b(_adapter *adapter, u8 cap);
bool hal_chk_proto_cap_22b(_adapter *adapter, u8 cap);
bool hal_is_band_support_22b(_adapter *adapter, u8 band);
bool hal_is_bw_support_22b(_adapter *adapter, u8 bw);
bool hal_is_wireless_mode_support_22b(_adapter *adapter, u8 mode);
u8 hal_largest_bw_22b(_adapter *adapter, u8 in_bw);

bool hal_chk_wl_func_22b(_adapter *adapter, u8 func);
...
void rtw_restore_mac_addr_22b(_adapter *adapter);/*set mac addr when hal_init for all iface*/
...
u8 rtw_hal_rcr_check_22b(_adapter *adapter, u32 check_bit);

u8 rtw_hal_rcr_add_22b(_adapter *adapter, u32 add);
u8 rtw_hal_rcr_clear_22b(_adapter *adapter, u32 clear);
...
void rtw_hal_ch_sw_iqk_info_backup_22b(_adapter *adapter);
void rtw_hal_ch_sw_iqk_info_restore_22b(_adapter *padapter, u8 ch_sw_use_case);
	...
	extern char rtw_phy_para_file_path_22b[PATH_LENGTH_MAX];
...
int rtw_hal_get_rsvd_page_22b(_adapter *adapter, u32 page_offset, u32 page_num, u8 *buffer, u32 buffer_size);
void rtw_hal_construct_beacon(_adapter *padapter, u8 *pframe, u32 *pLength);
void rtw_hal_construct_NullFunctionData_22b(PADAPTER, u8 *pframe, u32 *pLength,
...
s16 translate_dbm_to_percentage_22b(s16 signal);
