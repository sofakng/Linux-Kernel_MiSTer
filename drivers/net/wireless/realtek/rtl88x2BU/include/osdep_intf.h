...
uint loadparam_22b(_adapter *adapter);
...
u8 rtw_rtnl_lock_needed_22b(struct dvobj_priv *dvobj);
void rtw_set_rtnl_lock_holder_22b(struct dvobj_priv *dvobj, _thread_hdl_ thd_hdl);
