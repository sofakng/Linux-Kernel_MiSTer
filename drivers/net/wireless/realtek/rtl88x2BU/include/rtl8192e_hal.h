...
u8 SetHwReg_22b8192E(PADAPTER Adapter, u8 variable, u8 *val);
void GetHwReg_22b8192E(PADAPTER Adapter, u8 variable, u8 *val);
u8
SetHalDefVar_22b8192E(
	IN	PADAPTER				Adapter,
	IN	HAL_DEF_VARIABLE		eVariable,
	IN	PVOID					pValue
);
u8
GetHalDefVar_22b8192E(
	IN	PADAPTER				Adapter,
	IN	HAL_DEF_VARIABLE		eVariable,
	IN	PVOID					pValue
);
