...
int rtw_mi_get_ch_setting_union_22b(_adapter *adapter, u8 *ch, u8 *bw, u8 *offset);
int rtw_mi_get_ch_setting_union_22b_no_self(_adapter *adapter, u8 *ch, u8 *bw, u8 *offset);
...
void rtw_mi_status_22b(_adapter *adapter, struct mi_state *mstate);
void rtw_mi_status_22b_no_self(_adapter *adapter, struct mi_state *mstate);
void rtw_mi_status_22b_no_others(_adapter *adapter, struct mi_state *mstate);

/* For now, not handle union_ch/bw/offset */
void rtw_mi_status_22b_merge(struct mi_state *d, struct mi_state *a);

void rtw_mi_update_iface_status_22b(struct mlme_priv *pmlmepriv, sint state);
...
extern void rtw_intf_start_22b(_adapter *adapter);
extern void rtw_intf_stop_22b(_adapter *adapter);
...
#else
#define rtw_mi_set_scan_deny_22b(adapter, ms) do {} while (0)
#define rtw_mi_buddy_set_scan_deny_22b(adapter, ms) do {} while (0)
#endif
...
#define DBG_IFACE_STATUS_DUMP(adapter)	dump_dvobj_mi_status_22b(RTW_DBGDUMP, __func__, adapter)
#endif
...
extern void rtw_iface_dynamic_chk_wk_hdl_22b(_adapter *padapter);
